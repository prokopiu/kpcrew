...
-- Load latest simbrief flight plan
    imgui.PushItemWidth(field_size);
    if imgui.Button("SIMBRIEF", 70, 20) then
...
-- Load/Save current briefing under filename in this field
    ...
    imgui.SameLine()
    if imgui.Button("LOAD", 70, 20) then
        activeBriefings:load()
    end

    imgui.SameLine()
    if imgui.Button("SAVE", 70, 20) then
        activeBriefings:save()
    end

-- Close the briefing window
    imgui.SameLine()
    if imgui.Button("CLOSE", 70, 20) then
        kb_hide_brief_wnd()
    end
...
-- Fuel: Total: 99999 KGS (MFUEL: 999999 KGS)  
-- Weight: Gross: 999999 KGS | ZFW: 999999 KGS (MZFW: 999999 KGS) | MTOW / MLW: 999999 KGS / 999999 KGS
-- ---------------------------------------------------------------------------------------
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Weight: Gross:")
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF95C857)
...
-- ---------------------------------------------------------------------------------------
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Trans Altitude/Level: " .. activeBriefings:get("flight:originIcao"))
    imgui.SameLine()
	imgui.PushItemWidth(40);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("takeoff trans alt:")
	imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("departure:transalt"), 0)
	if changed then
		activeBriefings:set("departure:transalt",textin)
	end
	imgui.PopStyleColor()
	imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted(activeBriefings:get("flight:destinationIcao") .. " FL")
    imgui.SameLine()
	imgui.PushItemWidth(40);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("arr trans lvl:")
	imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("arrival:translvl")/100, 0)
	if changed then
		activeBriefings:set("arrival:translvl",textin)
	end
	imgui.PopStyleColor()
	imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted(activeBriefings:get("flight:alternateIcao") .. " FL")
    imgui.SameLine()
	imgui.PushItemWidth(40);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("alt trans lvl:")
	imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("arrival:alttranslvl")/100, 0)
	if changed then
		activeBriefings:set("arrival:alttranslvl",textin)
	end
	imgui.PopStyleColor()
	imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    if imgui.Button("RST", 30, 20) then
   		activeBckVars:set("general:timesOFF","==:==") 
   		activeBckVars:set("general:timesOUT","==:==") 
   		activeBckVars:set("general:timesIN","==:==") 
   		activeBckVars:set("general:timesON","==:==") 
	...
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("Cost Index:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("flight:costIndex"), 0)
	if changed then
		activeBriefings:set("flight:costIndex",textin)
	end
    imgui.PopStyleColor()
    imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
    imgui.TextUnformatted(activeBriefings:get("flight:distance"))
    imgui.PopStyleColor()
	...
	imgui.PushItemWidth(60);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("Avg Wind:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputText("", activeBriefings:get("flight:averageWind"), 255)
	if changed then
		activeBriefings:set("flight:averageWind",textin)
	end
    imgui.PopStyleColor()
    imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("| Avg WC:")
    imgui.SameLine()
	imgui.PushItemWidth(30);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("Avg WC:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("flight:averageWC"), 0)
	if changed then
		activeBriefings:set("flight:averageWC",textin)
	end
    imgui.PopStyleColor()
    imgui.PopItemWidth()
	imgui.PopStyleVar();
	...
	imgui.PushItemWidth(20);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("Avg ISA:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("flight:averageISA"), 0)
	if changed then
		activeBriefings:set("flight:averageISA",textin)
	end
    imgui.PopStyleColor()
    imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Taxi: Parked:")
    imgui.SameLine()
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Departure: RWY:")
    imgui.SameLine()
	imgui.PushItemWidth(28);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("Departure Runway:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
    ...
    imgui.SameLine()
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("| APT Elev:")
    imgui.SameLine()
	imgui.PushItemWidth(40);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("aptelev:")
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFF1b9af8)
	local changed, textin = imgui.InputInt("", activeBriefings:get("arrival:aptElevation"), 0)
	if changed then
		activeBriefings:set("arrival:aptElevation",textin)
	end
    imgui.PopStyleColor()
    imgui.PopItemWidth()
	imgui.PopStyleVar();
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Approach: Flaps")
    imgui.SameLine()
	imgui.PushItemWidth(45);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
	imgui.PushID("takeoff flaps:")
    ...
    imgui.PushStyleColor(imgui.constant.Col.Text, 0xFFCCCCCC)
    imgui.TextUnformatted("Approach: CRS1:")
    imgui.SameLine()
	imgui.PushItemWidth(30);
	imgui.PushStyleVar_2(imgui.constant.StyleVar.FramePadding, 3, 0);
