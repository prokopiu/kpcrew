...
These are the elements of the Control Window:
 ...
 - **[Current procedure/checklist]**: Shows the current checklist or procedure to be executed or just executing
...
### Selecting and Starting Procedures/Checklists 

The procedures do come in the sequence they are supposed to be executed during the flight. Some of them can be optional and you can skip them (depends on aircraft type). You can also choose to only run the checklist and jump over the associated procedures.

To skip a procedure or checklist use the **\[>\]** button. Skipping procedures means that certain settings  have not been made and you may have to do them yourself. 

To start a procedure/checklist use the **\[M\]** button (or the command associated to a key/joystick button).

Sample sequence of procedures/checklists for the Zibo Mod B738:

 1. PRELIMINARY PREFLIGHT PROCEDURE
 2. FLIGHT PREPARATIONS
 3. PREFLIGHT PROCEDURE
 4. PREFLIGHT CHECKLIST (PM)
 5. FLIGHT BRIEFINGS
 6. BEFORE START PROCEDURE
 7. BEFORE START CHECKLIST (F/O)
 8. STARTUP AND PUSHBACK
 9. BEFORE TAXI CHECKLIST (F/O)
 10. BEFORE TAKEOFF CHECKLIST (F/O)
 11. ENTERING RUNWAY PROCEDURE
 12. TAKEOFF & CLIMB
 13. AFTER TAKEOFF CHECKLIST (PM)
 14. APPROACH BRIEFING
 15. DESCEND CHECKLIST (PM)
 16. APPROACH CHECKLIST (PM)
 17. LANDING
 18. LANDING CHECKLIST (PM)
 19. FINAL
 20. CLEANUP
 21. SHUTDOWN
 22. SHUTDOWN CHECKLIST (F/O)
 23. SECURE AIRCRAFT
 24. SECURE AIRCRAFT CHECKLIST (F/O)
 25. TURN AROUND STATE
 26. COLD & DARK
 
 See also [Zibo Mod B738 Flows](../aircraft/KPCrew%20v2.2%20B738%20Flows.pdf)
