--[[
	*** KPCREW for FlyJsim Boeing 737-200
	Kosta Prokopiu, 2021
	Changelog:
		* v0.1 - Initial version only control 
		* v2.0 - new concept
		* V2.1 - B732 initial setup
--]]

-- Briefing / Aircraft specific details
B732 = Class_ACF:Create()
B732:setDEP_Flaps({"0","1","2","5","10","15","25"})
B732:setDEP_Flaps_val({0,0.125,0.25,0.375,0.5,0.625,0.75})
B732:setAPP_Flaps({"15","30","40"})
B732:setAPP_Flaps_val({0.625,0.875,1})
B732:setAutoBrake({"OFF","MN","MED","MAX",""})
B732:setAutoBrake_val({0,1,2,3,3})
B732:setTakeoffThrust({"Normal","Reduced","",""})
B732:setTakeoffThrust_Val({0,1,2,3})
B732:setBleeds({"OFF","ON","UNDER PRESSURIZED"})
B732:setBleeds_val({0,1,2})
B732:setAIce({"Not Required","Engine Only","Engine and Wing"})
B732:setAIce_val({0,1,2})
B732:setDepApMode({"HDG/IAS","VORLOC/IAS"})
B732:setDepApMode_val({0,1})

set_zc_config("acfname","Boeing 737-200")
set_zc_config("acficao","B732")

DEP_takeofthrust_list = B732:getTakeoffThrust()
DEP_aice_list = B732:getAIce()
DEP_bleeds_list = B732:getBleeds()
...
ZC_INIT_PROC = {
	[0] = {["lefttext"] = "ZIBOCREW ".. ZC_VERSION .. " STARTED",["timerincr"] = -1,
		["actions"] = function ()
			gLeftText = "KPCREW ".. ZC_VERSION .. " FJS B737-200"
...
ZC_PRE_FLIGHT_PROC = {
	...
	[25] = {["lefttext"] = "FO: HYDRAULIC PANEL SET", ["timerincr"] = 1,
		["actions"] = function ()
			set("FJS/732/num/FlipPo_16",0)
			set("FJS/732/num/FlipPo_17",0)
			set("FJS/732/FltControls/AntiSkidINBDSwitch",1)
			set("FJS/732/FltControls/AntiSkidOUTBDSwitch",1)
			set("FJS/732/FltControls/Elec1HydPumpSwitch",0)
		end
	}, 
	...
	[47] = {["lefttext"] = "FO: FUEL QTY TEST", ["timerincr"] = 1,
		["actions"] = function ()
...
-- PRELIMINARY FLIGHT COMPARTMENT CHECKLIST
-- OVERHEAT DETECTION		...........	CHECKED
-- FIRE WARNING				...........	CHECKED
-- EXTINGUISHER TEST SW		...........	CHECKED
-- CARGO SMOKE/FIRE SYSTEM	...........	CHECKED
-- APU (IF REQUIRED)		...........	START/ON BUSSES
-- EMERGENCY EQUIPMENT		...........	CHECKED
-- CIRCUIT BREAKERS			...........	CHECKED
-- FLIGHT RECORDER			...........	TEST
-- MACH AIRSPEED WARNING	...........	TEST
-- STALL WARNING			...........	TEST
-- PASSENGER OXYGEN SW		...........	NORMAL
-- GALLEY POWER				...........	ON
-- EMERGENCY EXIT LIGHTS	...........	ARMED
-- NO SMOKING SIGNS			...........	SET
...
-- YAW DAMPER				...........	ON
-- NAVIGATION TRANSFER		...........	NORMAL
-- PAPERS					...........	ABOARD
-- FMC/CDU					...........	SET

ZC_PREL_FLIGHT_COMP_CHECKLIST = {
	[0] = {["lefttext"] = "PRELIMINARY FLIGHT COMPARTMENT CHECKLIST", ["timerincr"] = 3,
		["actions"] = function ()
			speakNoText(0,"PRELIMINARY FLIGHT COMPARTMENT CHECKLIST")
			setchecklist(1)
		end
	},
	[1] = {["lefttext"] = "OVERHEAT DETECTION -- CHECKED", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"OVERHEAT DETECTION")
		end
	},
	[2] = {["lefttext"] = "OVERHEAT DETECTION -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[3] = {["lefttext"] = "FIRE WARNING -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"FIRE WARNING")
		end
	},
	[4] = {["lefttext"] = "FIRE WARNING -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[5] = {["lefttext"] = "EXTINGUISHER TEST SWITCH -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"EXTINGUISHER TEST SWITCH")
		end
	},
	[6] = {["lefttext"] = "EXTINGUISHER TEST SWITCH -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[7] = {["lefttext"] = "CARGO SMOKE/FIRE SYSTEM -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"CARGO SMOKE AND FIRE SYSTEM")
		end
	},
	[8] = {["lefttext"] = "CARGO SMOKE/FIRE SYSTEM -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[9] = {["lefttext"] = "APU (IF REQUIRED) -- START/ON BUS", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"A P U")
		end
	},
	[10] = {["lefttext"] = "APU (IF REQUIRED) -- START/ON BUS", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"STARTED AND ON BUS")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[11] = {["lefttext"] = "EMERGENCY EQUIPMENT -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"EMERGENCY EQUIPMENT")
		end
	},
	[12] = {["lefttext"] = "EMERGENCY EQUIPMENT -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[13] = {["lefttext"] = "CIRCUIT BREAKERS -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"CIRCUIT BREAKERS")
		end
	},
	[14] = {["lefttext"] = "CIRCUIT BREAKERS -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[15] = {["lefttext"] = "FLIGHT RECORDER -- TESTED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"FLIGHT RECORDER")
		end
	},
	[16] = {["lefttext"] = "FLIGHT RECORDER -- TESTED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"TESTED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[17] = {["lefttext"] = "MACH AIRSPEED WARNING -- TESTED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"MACH AIRSPEED WARNING")
		end
	},
	[18] = {["lefttext"] = "MACH AIRSPEED WARNING -- TESTED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"TESTED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[19] = {["lefttext"] = "STALL WARNING -- TESTED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"STALL WARNING")
		end
	},
	[20] = {["lefttext"] = "STALL WARNING -- TESTED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"TESTED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[21] = {["lefttext"] = "PASSENGER OXYGEN SWITCH -- NORMAL", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"PASSENGER OXYGEN SWITCH")
			if get_zc_config("easy") then
				set("FJS/732/num/PassOxySwitch",0)
				set("FJS/732/num/FlipPo_14",0)
			end
			
		end
	},
	[22] = {["lefttext"] = "PASSENGER OXYGEN SWITCH -- NORMAL", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"NORMAL")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[23] = {["lefttext"] = "GALLEY POWER -- ON", ["timerincr"] = 2,
		["actions"] = function ()
	...
	[24] = {["lefttext"] = "GALLEY POWER -- ON", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"ON")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[25] = {["lefttext"] = "EMERGENCY EXIT LIGHTS -- ARMED", ["timerincr"] = 2,
		["actions"] = function ()
	...
	[26] = {["lefttext"] = "EMERGENCY EXIT LIGHTS -- ARMED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"ARMED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[27] = {["lefttext"] = "NO SMOKING SIGNS -- SET", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"NO SMOKING SIGNS")
			if get_zc_config("easy") then
				set("FJS/732/lights/NoSmokingSwitch",2)
			end
		end
	},
	[28] = {["lefttext"] = "NO SMOKING SIGNS -- SET", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"SET")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[29] = {["lefttext"] = "AUTO PILOT -- DISENGAGED", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"AUTOPILOT")
			if get_zc_config("easy") then
	...
	[30] = {["lefttext"] = "AUTO PILOT -- DISENGAGED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"DISENGAGED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[31] = {["lefttext"] = "ANTI-SKID -- ON", ["timerincr"] = 2,
		["actions"] = function ()
	...
	[32] = {["lefttext"] = "AUTO PILOT -- DISENGAGED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"ON")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[33] = {["lefttext"] = "FLAP LEVER -- CHECKED", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"FLAP LEVER")
			if get_zc_config("easy") then
				set("sim/cockpit2/controls/flap_ratio",0)
			end
		end
	},
	[34] = {["lefttext"] = "FLAP LEVER - CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[35] = {["lefttext"] = "STABILIZER TRIM CUTOUT SWITCHES -- NORMAL", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"STABILIZER TRIM CUTOUT SWITCHES")
		end
	},
	[36] = {["lefttext"] = "STABILIZER TRIM CUTOUT SWITCHES -- NORMAL", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"NORMAL")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[37] = {["lefttext"] = "WHEEL WELL FIRE WARNING -- CHECKED", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"WHEEL WELL FIRE WARNING")
		end
	},
	[38] = {["lefttext"] = "WHEEL WELL FIRE WARNING -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[39] = {["lefttext"] = "LIGHT TEST -- CHECKED", ["timerincr"] = 1,
		["actions"] = function ()
			speakNoText(0,"LIGHT TEST")
		end
	},
	[40] = {["lefttext"] = "LIGHT TEST -- CHECKED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"CHECKED")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[41] = {["lefttext"] = "RUDDER & AILERON TRIM -- FREE & ZERO", ["timerincr"] = 2,
		["actions"] = function ()
	...
	[42] = {["lefttext"] = "RUDDER & AILERON TRIM -- FREE & ZERO", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"FREE and Zero")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[43] = {["lefttext"] = "YAW DAMPER -- ON", ["timerincr"] = 1,
		["actions"] = function ()
	...
	[44] = {["lefttext"] = "YAW DAMPER -- ON", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"ON")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[45] = {["lefttext"] = "NAVIGATION TRANSFER -- NORMAL", ["timerincr"] = 1,
		["actions"] = function ()
	...
	[46] = {["lefttext"] = "NAVIGATION TRANSFER -- AUTO", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"NORMAL")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[47] = {["lefttext"] = "PAPERS -- ON BOARD", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"Papers")
		end
	},
	[48] = {["lefttext"] = "PAPERS -- ON BOARD", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"on board")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[49] = {["lefttext"] = "FMC/CDU -- SET", ["timerincr"] = 2,
		["actions"] = function ()
			speakNoText(0,"f m c and c d u")
		end
	},
	[50] = {["lefttext"] = "FMC/CDU -- SET", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"set")
			command_once("bgood/xchecklist/check_item")
		end
	},
	[51] = {["lefttext"] = "PRELIMINARY FLIGHT COMPARTMENT CHECKLIST", ["timerincr"] = 4,
		["actions"] = function ()
			speakNoText(0,"PRELIMINARY FLIGHT COMPARTMENT CHECKLIST COMPLETED")
		end
	},
	[52] = {["lefttext"] = "PRELIMINARY FLIGHT COMPARTMENT CHECKLIST", ["timerincr"] = -1,
		["actions"] = function ()
...
ZC_BEFORE_TAXI_CHECKLIST = {
	...
	[12] = {["lefttext"] = "APU -- AS REQUIRED", ["timerincr"] = 997,
		["actions"] = function ()
			speakNoText(0,"AS REQUIRED")
			command_once("bgood/xchecklist/check_item")
		end
...
function zc_get_procedure()
	...
	if lProcIndex == incnt then
		...
		lNameActiveProc = incnt.." PRELIMINARY FLIGHT COMPARTMENT CHECKLIST"
	end
	incnt=incnt+1
	if lProcIndex == incnt then
	...
	if lProcIndex == incnt then
		...
		lNameActiveProc = incnt.." FLIGHT CONTROLS CHECK - OPTIONAL"
	end	
	incnt=incnt+1
	if lProcIndex == incnt then
...
create_command("kp/xsp/beacon_lights_switch_on",	"B732 Beacon Lights On",	"xsp_beaconlights_on()", "", "")
create_command("kp/xsp/beacon_lights_switch_off",	"B732 Beacon Lights Off",	"xsp_beaconlights_off()", "", "")
create_command("kp/xsp/dome_lights_switch_on",		"B732 Dome Lights On",		"xsp_domelight_on()", "", "")
create_command("kp/xsp/dome_lights_switch_off",		"B732 Dome Lights Off",		"xsp_domelight_off()", "", "")
create_command("kp/xsp/nav_lights_switch_on",		"B732 Position Lights On",	"xsp_navlight_on()", "", "")
create_command("kp/xsp/nav_lights_switch_off",		"B732 Position Lights Off",	"xsp_navlight_off()", "", "")
create_command("kp/xsp/strobe_lights_switch_on",	"B732 Strobe Lights On",	"xsp_strobelight_on()", "", "")
create_command("kp/xsp/strobe_lights_switch_off",	"B732 Strobe Lights Off",	"xsp_strobelight_off()", "", "")
create_command("kp/xsp/taxi_lights_switch_on",		"B732 Taxi Lights On",		"xsp_taxilights_on()", "", "")
create_command("kp/xsp/taxi_lights_switch_off",		"B732 Taxi Lights Off",		"xsp_taxilights_off()", "", "")
create_command("kp/xsp/landing_lights_switch_on",	"B732 Landing Lights On",	"xsp_landinglights_on()", "", "")
create_command("kp/xsp/landing_lights_switch_off",	"B732 Landing Lights Off",	"xsp_landinglights_off()", "", "")
create_command("kp/xsp/wing_lights_switch_on",		"B732 Wing Lights On",		"xsp_winglights_on()", "", "")
create_command("kp/xsp/wing_lights_switch_off",		"B732 Wing Lights Off",		"xsp_winglights_off()", "", "")
create_command("kp/xsp/logo_lights_switch_on",		"B732 Logo Lights On",		"xsp_logolights_on()", "", "")
create_command("kp/xsp/logo_lights_switch_off",		"B732 Logo Lights Off",		"xsp_logolights_off()", "", "")
create_command("kp/xsp/toggle_both_fd",				"B732 Toggle Both FD",		"xsp_toggle_fd_both()", "", "")
create_command("kp/xsp/toggle_both_std",			"B732 Toggle Both STD",		"xsp_toggle_std_both()", "", "")
