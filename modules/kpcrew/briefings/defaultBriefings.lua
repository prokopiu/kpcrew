...
flight:add(kcPreference:new("originRegion","",kcPreference.typeText,"*Origin Region|"))
...
flight:add(kcPreference:new("destinationRegion","",kcPreference.typeText,"*Destination Region|"))
...
flight:add(kcPreference:new("alternateRegion","",kcPreference.typeText,"*Alternate Region|"))
