...
departure:add(kcPreference:new("metarto",0,kcPreference.typeExecButton,"METAR|Load |kc_fill_to_metar()"))
...
approach:add(kcPreference:new("div",0,kcPreference.typeDivider,"Approach ------------|"))
