...
arrival:add(kcPreference:new("atisFrequency","",kcPreference.typeText,"ATIS Frequency|"))
...
arrival:add(kcPreference:new("appFrequency","",kcPreference.typeText,"Approach Frequency|"))
...
approach:add(kcPreference:new("twrFrequency","",kcPreference.typeText,"Tower Frequency|"))
approach:add(kcPreference:new("gndFrequency","",kcPreference.typeText,"Ground Frequency|"))
approach:add(kcPreference:new("nav1Frequency","",kcPreference.typeText,"NAV1/ILS Frequency|"))
approach:add(kcPreference:new("nav1Course",0,kcPreference.typeInt,"NAV1 CRS|10"))
approach:add(kcPreference:new("nav2Frequency","",kcPreference.typeText,"NAV2 Frequency|"))
