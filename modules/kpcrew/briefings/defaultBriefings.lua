...
-- runway states
kc_DEP_rwystate_list 	= "DRY|WET|CONT"
...
-- function kc_download_simbrief()
	...
	-- if activePrefSet:get("general:simbriefuser") ~= nil and activePrefSet:get("general:simbriefuser") ~= " " then
		...
		-- if webStatus == 200 then
			...
			-- f:close()
		-- else
			-- kc_speakNoText(0,"Error downloading sim brief")
		-- end
...
-- departure:add(kcPreference:new("nav1Frequency",109.00,kcPreference.typeNAVFreq,"NAV1/ILS Frequency|1"))
-- departure:add(kcPreference:new("nav2Frequency",109.00,kcPreference.typeNAVFreq,"NAV2 Frequency|2"))
...
arrival:add(kcPreference:new("translvl",activePrefSet:get("general:def_trans_lvl"),kcPreference.typeInt,"*Transition Level(FL)|100"))
...
-- approach:add(kcPreference:new("gav2",0,kcPreference.typeInt,"*Go Around V2|1"))
