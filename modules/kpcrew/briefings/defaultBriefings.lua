...
departure:add(kcPreference:new("atisPrecipit",1,kcPreference.typeList,"ATIS Precipitation|" .. kc_WX_Precipitation_list))
departure:add(kcPreference:new("atisClouds",1,kcPreference.typeList,"ATIS Clouds|" .. kc_WX_Cloud_list))
