...
departure:add(kcPreference:new("AtisFrequency1",122800,kcPreference.typeCOMFreq,"ATIS Frequency|"))
...
departure1:add(kcPreference:new("clrFrequency",122800,kcPreference.typeCOMFreq,"Clearance Frequency|"))
...
departure2:add(kcPreference:new("depFrequency",122800,kcPreference.typeCOMFreq,"Departure Frequency|"))
...
departure3:add(kcPreference:new("nav1Frequency",10900,kcPreference.typeNAVFreq,"NAV1/ILS Frequency|1"))
departure3:add(kcPreference:new("nav1Course",0,kcPreference.typeInt,"NAV1 CRS|10"))
departure3:add(kcPreference:new("nav2Frequency",10900,kcPreference.typeNAVFreq,"NAV2 Frequency|2"))
...
taxi:add(kcPreference:new("gndFrequency1",122800,kcPreference.typeCOMFreq,"Ground Frequency|"))
taxi:add(kcPreference:new("towerFrequency1",122800,kcPreference.typeCOMFreq,"Tower Frequency|"))
...
arrival1:add(kcPreference:new("appFrequency",122800,kcPreference.typeCOMFreq,"Approach Frequency|"))
...
approach:add(kcPreference:new("twrFrequency2",122800,kcPreference.typeCOMFreq,"Tower Frequency|"))
approach:add(kcPreference:new("nav1Frequency",10900,kcPreference.typeNAVFreq,"NAV1/ILS Frequency|1"))
approach:add(kcPreference:new("nav1Course",0,kcPreference.typeInt,"NAV1 CRS|10"))
approach:add(kcPreference:new("nav2Frequency",10900,kcPreference.typeNAVFreq,"NAV2 Frequency|2"))
...
approach2:add(kcPreference:new("gndFrequency2",122800,kcPreference.typeCOMFreq,"Ground Frequency|"))
