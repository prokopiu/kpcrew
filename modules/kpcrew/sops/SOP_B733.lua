...
activeSOP = kcSOP:new("IXEG B733 SOP")
...
electricalPowerUpProc:addItem(kcProcedureItem:new("DC POWER SELECTOR","BAT BUS",kcFlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(kcProcedureItem:new("AC POWER SELECTOR","APU GEN",kcFlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(kcProcedureItem:new("BATTERY SWITCH","ON",kcFlowItem.actorFO,2,
	function () return sysElectric.batterySwitch:getStatus() == 0 end,
	function () sysElectric.batterySwitch:actuate(0) end))
