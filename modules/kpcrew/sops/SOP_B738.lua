...
electricalPowerUpProc:addItem(ProcedureItem:new("STANDBY POWER SWITCH","GUARD CLOSED",ChecklistItem.actorFO,1,function (self) return sysElectric.stbyPowerCover:getStatus() == 0 end,nil,nil))
electricalPowerUpProc:addItem(ProcedureItem:new("ALTERNATE FLAPS MASTER SWITCH","GUARD CLOSED",ChecklistItem.actorFO,1,function (self) return sysControls.altFlapsCover:getStatus() == 0 end,nil,nil))
...
electricalPowerUpProc:addItem(ProcedureItem:new("LANDING GEAR LEVER","DOWN",ChecklistItem.actorFO,1,function (self) return sysGeneral.GearSwitch:getStatus() == 1 end,nil,nil))
...
electricalPowerUpProc:addItem(SimpleProcedureItem:new("If external power is needed:",function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("  Use Zibo EFB to turn Ground Power on.",function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(ProcedureItem:new("  GRD POWER AVAILABLE LIGHT","ILLUMINATED",ChecklistItem.actorFO,1,function (self) return sysElectric.gpuAvailAnc:getStatus() == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(ProcedureItem:new("  GROUND POWER SWITCH","ON",ChecklistItem.actorFO,1,function (self) return sysElectric.gpuSwitch:getStatus() == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("    Verify that SOURCE OFF, TRANSFER BUS OFF, ",function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("    and STANDBY PWR OFF lights are extinguished",function () return activePrefSet:getPreference("aircraft:powerup") == true end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("If APU power is needed:",function () return activePrefSet:getPreference("aircraft:powerup") == false end))
...
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  OVHT FIRE TEST SWITCH","HOLD RIGHT",ChecklistItem.actorFO,1,function (self) return  sysEngines.ovhtFireTestSwitch:getStatus() > 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  MASTER FIRE WARN LIGHT","PUSH",ChecklistItem.actorFO,1,function (self) return sysGeneral.fireWarningAnc:getStatus() > 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  ENGINES EXT TEST SWITCH","TEST 1 TO LEFT",ChecklistItem.actorFO,1,function (self) return get("laminar/B738/toggle_switch/extinguisher_circuit_test") < 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  ENGINES EXT TEST SWITCH","TEST 2 TO RIGHT",ChecklistItem.actorFO,1,function (self) return get("laminar/B738/toggle_switch/extinguisher_circuit_test") > 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("  APU","START",ChecklistItem.actorFO,1,function (self) return sysElectric.apuRunningAnc:getStatus() == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("    Hold APU switch in START position for 3-4 seconds.",function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("  APU GEN OFF BUS LIGHT","ILLUMINATED",ChecklistItem.actorFO,1,function (self) return sysElectric.apuGenBusOff:getStatus() == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("  APU GENERATOR BUS SWITCHES","ON",ChecklistItem.actorFO,1,function (self) return sysElectric.apuGenBus1:getStatus() == 1 and sysElectric.apuGenBus2:getStatus() == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("STANDBY POWER","ON",ChecklistItem.actorFO,1,function (state) return get("laminar/B738/electric/standby_bat_pos") > 0 end,nil,nil))
...
prelPreflightProc:addItem(IndirectProcedureItem:new("ATTENDENCE BUTTON","PRESS",ChecklistItem.actorFO,1,function (self) return sysGeneral.attendanceButton:getStatus() > 0 end,nil,nil))
...
prelPreflightProc:addItem(ProcedureItem:new("COCKPIT LIGHTS","SET AS NEEDED",ChecklistItem.actorFO,1,nil,function () if is_daylight() then return "AS NEEDED" else return "ON" end end,nil))
prelPreflightProc:addItem(ProcedureItem:new("WING & WHEEL WELL LIGHTS","AS REQUIRED","F/O",1,nil,function () if is_daylight() then return "AS REQUIRED" else return "ON" end end,nil))
prelPreflightProc:addItem(ProcedureItem:new("FUEL PUMPS","ALL OFF","F/O",1,function (self) return get("laminar/B738/fuel/fuel_tank_pos_lft1") == 0 and get("laminar/B738/fuel/fuel_tank_pos_lft2") == 0 and get("laminar/B738/fuel/fuel_tank_pos_rgt1") == 0 and get("laminar/B738/fuel/fuel_tank_pos_rgt2") == 0 and get("laminar/B738/fuel/fuel_tank_pos_ctr1") == 0 and get("laminar/B738/fuel/fuel_tank_pos_ctr2") == 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == true end))
prelPreflightProc:addItem(ProcedureItem:new("FUEL PUMPS","ALL OFF","F/O",1,function (self) return get("laminar/B738/fuel/fuel_tank_pos_lft2") == 0 and get("laminar/B738/fuel/fuel_tank_pos_rgt1") == 0 and get("laminar/B738/fuel/fuel_tank_pos_rgt2") == 0 and get("laminar/B738/fuel/fuel_tank_pos_ctr1") == 0 and get("laminar/B738/fuel/fuel_tank_pos_ctr2") == 0 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
prelPreflightProc:addItem(ProcedureItem:new("FUEL PUMP FOR APU","AS REQUIRED","F/O",1,function () return get("laminar/B738/fuel/fuel_tank_pos_lft1") == 1 end,nil,nil,function () return activePrefSet:getPreference("aircraft:powerup") == false end))
