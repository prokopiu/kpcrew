...
electricalPowerUpProc:addItem(ProcedureItem:new("CIRCUIT BREAKERS (P6 PANEL)","CHECK ALL IN",FlowItem.actorFO,3,true))
electricalPowerUpProc:addItem(ProcedureItem:new("CIRCUIT BREAKERS (CONTROL STAND,P18 PANEL)","CHECK ALL IN",FlowItem.actorFO,3,true))
electricalPowerUpProc:addItem(ProcedureItem:new("DC POWER SWITCH","BAT",FlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(ProcedureItem:new("BATTERY SWITCH","GUARD CLOSED",FlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(ProcedureItem:new("STANDBY POWER SWITCH","GUARD CLOSED",FlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(ProcedureItem:new("ELECTRIC HYDRAULIC PUMPS SWITCHES","OFF",FlowItem.actorFO,3,
	function () return sysHydraulic.elecHydPumpGroup:getStatus() == 0 end,
	function () sysHydraulic.elecHydPumpGroup:actuate(modeOff) end))
electricalPowerUpProc:addItem(ProcedureItem:new("ALTERNATE FLAPS MASTER SWITCH","GUARD CLOSED",FlowItem.actorFO,3,
	function () return sysControls.altFlapsCover:getStatus() == modeOff end,
	function () sysControls.altFlapsCover:actuate(modeOff) end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("FLAP LEVER","SET CORRECTLY",FlowItem.actorFO,1,"initial_flap_lever",
	function () return sysControls.flapsSwitch:getStatus() == 0 end))
electricalPowerUpProc:addItem(SimpleProcedureItem:new("  Set the flap lever to agree with the flap position."))

electricalPowerUpProc:addItem(SimpleProcedureItem:new("==== Other"))
electricalPowerUpProc:addItem(ProcedureItem:new("WINDSHIELD WIPER SELECTORS","PARK",FlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(ProcedureItem:new("  RED LANDING GEAR LIGHT","CHECK EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysGeneral.gearLightsRed:getStatus() == modeOff end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("TAKEOFF CONFIG WARNING","TEST",FlowItem.actorFO,2,"takeoff_config_warn",
...
electricalPowerUpProc:addItem(ProcedureItem:new("  OVHT DET SWITCH","NORMAL",FlowItem.actorFO,1,true,
	function () sysElectric.gpuSwitch:step(cmdUp) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  #exchange|OVHT|Overheat# FIRE TEST SWITCH","HOLD RIGHT",FlowItem.actorFO,2,"ovht_fire_test",
	function () return  sysEngines.ovhtFireTestSwitch:getStatus() > 0 end,
	function () sysEngines.ovhtFireTestSwitch:repeatOn() end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("  MASTER FIRE WARN LIGHT","PUSH",FlowItem.actorFO,1,true,
	function () sysEngines.ovhtFireTestSwitch:repeatOff() end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  ENGINES #exchange|EXT|Extinguischer# TEST SWITCH","TEST 1 TO LEFT",FlowItem.actorFO,2,"eng_ext_test_1",
	...
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  ENGINES #exchange|EXT|Extinguischer# TEST SWITCH","TEST 2 TO RIGHT",FlowItem.actorFO,2,"eng_ext_test_2",
	function () return get("laminar/B738/toggle_switch/extinguisher_circuit_test") > 0 end,
...
electricalPowerUpProc:addItem(SimpleProcedureItem:new("    Hold APU switch in START position for 3-4 seconds.",
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(IndirectProcedureItem:new("  #spell|APU# GEN OFF BUS LIGHT","ILLUMINATED",FlowItem.actorFO,1,"apu_gen_bus_off",
	...
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
electricalPowerUpProc:addItem(ProcedureItem:new("  #spell|APU# GENERATOR BUS SWITCHES","ON",FlowItem.actorFO,2,
...
electricalPowerUpProc:addItem(ProcedureItem:new("TRANSFER BUS LIGHTS","CHECK EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysElectric.transferBus1:getStatus() == modeOff and sysElectric.transferBus2:getStatus() == modeOff end))
electricalPowerUpProc:addItem(ProcedureItem:new("SOURCE OFF LIGHTS","CHECK EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysElectric.sourceOff1:getStatus() == modeOff and sysElectric.sourceOff2:getStatus() == modeOff end))
electricalPowerUpProc:addItem(ProcedureItem:new("STANDBY POWER","ON",FlowItem.actorFO,2,
	function () return get("laminar/B738/electric/standby_bat_pos") > 0 end))
electricalPowerUpProc:addItem(ProcedureItem:new("   STANDBY #exchange|PWR|POWER# LIGHT","CHECK EXTINGUISHED",FlowItem.actorFO,2,
...
prelPreflightProc:addItem(ProcedureItem:new("FLIGHT DATA RECORDER SWITCH","GUARD CLOSED",FlowItem.actorFO,2,
...
prelPreflightProc:addItem(IndirectProcedureItem:new("MACH OVERSPEED TEST 1","PERFORM",FlowItem.actorFO,2,"mach_ovspd_test1",
...
prelPreflightProc:addItem(IndirectProcedureItem:new("MACH OVERSPEED TEST 2","PERFORM",FlowItem.actorFO,2,"mach_ovspd_test2",
...
prelPreflightProc:addItem(IndirectProcedureItem:new("STALL WARNING TEST 2","PERFORM",FlowItem.actorFO,2,"stall_warning_test",
...
prelPreflightProc:addItem(ProcedureItem:new("VOICE RECORDER SWITCH","AUTO",FlowItem.actorFO,2,
...
prelPreflightProc:addItem(ProcedureItem:new("EEC SWITCHES","ON",FlowItem.actorFO,2,
...
prelPreflightProc:addItem(ProcedureItem:new("EEC GUARDS","CLOSED",FlowItem.actorFO,2,
	function () return sysEngines.eecGuardGroup:getStatus() == 0 end,
	function () sysEngines.eecGuardGroup:actuate(0) end))
prelPreflightProc:addItem(ProcedureItem:new("EEC FAIL LIGHTS","EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysEngines.fadecFail:getStatus() == 0 end))
prelPreflightProc:addItem(ProcedureItem:new("REVERSER FAIL LIGHTS","EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysEngines.reversersFail:getStatus() == 0 end))

prelPreflightProc:addItem(SimpleProcedureItem:new("==== IRS Alignment"))
prelPreflightProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","OFF",FlowItem.actorFO,2,"irs_mode_initial_off",
...
prelPreflightProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","ALIGN",FlowItem.actorFO,2,"irs_mode_align",
...
prelPreflightProc:addItem(IndirectProcedureItem:new("  IRS LEFT ALIGN LIGHT","ILLUMINATES",FlowItem.actorFO,2,"irs_left_align",
	function () return sysGeneral.irs1Align:getStatus() == modeOn end))
prelPreflightProc:addItem(IndirectProcedureItem:new("  IRS RIGHT ALIGN LIGHT","ILLUMINATES",FlowItem.actorFO,2,"irs_right_align",
	function () return sysGeneral.irs2Align:getStatus() == modeOn end))
prelPreflightProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","THEN NAV",FlowItem.actorFO,2,"irs_mode_nav_again",
...
prelPreflightProc:addItem(IndirectProcedureItem:new("GPWS SYSTEM TEST","PERFORM",FlowItem.actorFO,1,"gpwstest",
...
prelPreflightProc:addItem(ProcedureItem:new("#spell|IFE# & GALLEY POWER","ON",FlowItem.actorFO,1,
...
cduPreflightProc:addItem(IndirectProcedureItem:new("    REF AIRPORT","SET",FlowItem.actorCPT,1,"ref_airport_set",
...
cduPreflightProc:addItem(IndirectProcedureItem:new("  RTE page:","OPEN",FlowItem.actorCPT,1,"rte_page",
	function () return string.find(sysFMC.fmcPageTitle:getStatus(),"RTE ") end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    ORIGIN","SET",FlowItem.actorCPT,1,"origin_set",
	function () return sysFMC.fmcOrigin:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    DEST","SET",FlowItem.actorCPT,1,"dest_set",
	function () return sysFMC.fmcDestination:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    FLT NO","SET",FlowItem.actorCPT,1,"flt_no_entered",
	function () return sysFMC.fmcFltNo:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    ROUTE","ENTER",FlowItem.actorCPT,1,"route_entered",
	function () return sysFMC.fmcRouteEntered:getStatus() == true end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    ROUTE","ACTIVATE",FlowItem.actorCPT,1,"route_activated",
	function () return sysFMC.fmcRouteActivated:getStatus() == true end))
cduPreflightProc:addItem(ProcedureItem:new("    ROUTE","EXECUTE",FlowItem.actorCPT,1,
	function () return sysFMC.fmcRouteExecuted:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("  DEPARTURES page:","OPEN",FlowItem.actorCPT,1,"departures_open",
...
cduPreflightProc:addItem(ProcedureItem:new("    ROUTE:","EXECUTE",FlowItem.actorCPT,1,
	function () return sysFMC.fmcRouteExecuted:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("  LEGS page:","OPEN",FlowItem.actorCPT,1,"legs_page_open",
...
cduPreflightProc:addItem(IndirectProcedureItem:new("  PERF INIT page:","OPEN",FlowItem.actorCPT,1,"perf_init_page",
	function () return string.find(sysFMC.fmcPageTitle:getStatus(),"PERF INIT") end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    ZFW","ENTER",FlowItem.actorCPT,1,"zfw_entered",
	function () return sysFMC.fmcZFWEntered:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    GW","ENTER/VERIFY",FlowItem.actorCPT,1,"gw_entered",
	function () return sysFMC.fmcGWEntered:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    RESERVES","ENTER/VERIFY",FlowItem.actorCPT,1,"reserves_entered",
	function () return sysFMC.fmcReservesEntered:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    COST INDEX","ENTER",FlowItem.actorCPT,1,"cost_index_entered",
	function () return sysFMC.fmcCIEntered:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("    CRZ ALT","ENTER",FlowItem.actorCPT,1,"crz_alt_entered",
	function () return sysFMC.fmcCrzAltEntered:getStatus() end))
cduPreflightProc:addItem(IndirectProcedureItem:new("  N1 LIMIT page:","OPEN",FlowItem.actorCPT,1,"n1_limit_page",
...
cduPreflightProc:addItem(IndirectProcedureItem:new("  TAKEOFF REF page:","OPEN",FlowItem.actorCPT,1,"takeoff_ref_page",
...
preflightFOProc:addItem(ProcedureItem:new("ELECTRIC HYDRAULIC PUMP SWITCHES","OFF",FlowItem.actorFO,3,
	function () return sysHydraulic.elecHydPumpGroup:getStatus() == 0 end,
	function () sysHydraulic.elecHydPumpGroup:actuate(modeOff) end))
...
preflightFOProc:addItem(ProcedureItem:new("ALTERNATE FLAPS MASTER SWITCH","GUARD CLOSED",FlowItem.actorFO,3,
	function () return sysControls.altFlapsCover:getStatus() == 0 end,
	function () sysControls.altFlapsCover:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("ALTERNATE FLAPS CONTROL SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysControls.altFlapsCtrl:getStatus() == 0 end,
	function () sysControls.altFlapsCtrl:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("FLAPS PANEL ANNUNCIATORS","EXTINGUISHED",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("FUEL PUMPS","ALL OFF",FlowItem.actorFO,2,
	...
	function () sysFuel.allFuelPumpGroup:actuate(modeOff) end,
	function () return activePrefSet:get("aircraft:powerup_apu") end))
preflightFOProc:addItem(ProcedureItem:new("FUEL VALVE ANNUNCIATORS","DIM",FlowItem.actorFO,2,
	function () return sysFuel.valveAnns:getStatus() == 1 end))
preflightFOProc:addItem(IndirectProcedureItem:new("FUEL CROSS FEED","ON FOR TEST",FlowItem.actorFO,2,"xfeedtest",
	function () return sysFuel.crossFeed:getStatus() == modeOn end,
	function () sysFuel.crossFeed:actuate(modeOn) end))
preflightFOProc:addItem(IndirectProcedureItem:new("CROSS FEED VALVE","CHECK DIM",FlowItem.actorFO,2,"xfeeddim",
...
preflightFOProc:addItem(ProcedureItem:new("FUEL CROSS FEED","OFF",FlowItem.actorFO,2,
	function () return sysFuel.crossFeed:getStatus() == modeOff end,
	function () sysFuel.crossFeed:actuate(modeOff) end))
preflightFOProc:addItem(ProcedureItem:new("CROSS FEED VALVE","EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysFuel.xfeedVlvAnn:getStatus() == 0 end))
...
preflightFOProc:addItem(SimpleProcedureItem:new("==== APU start if required",
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("OVHT DET SWITCH","NORMAL",FlowItem.actorFO,1,true,nil,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(IndirectProcedureItem:new("  #exchange|OVHT|Overheat# FIRE TEST SWITCH","HOLD RIGHT",FlowItem.actorFO,2,"ovht_fire_test",
	function () return  sysEngines.ovhtFireTestSwitch:getStatus() > 0 end,
	function () sysEngines.ovhtFireTestSwitch:repeatOn() end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("MASTER FIRE WARN LIGHT","PUSH",FlowItem.actorFO,1,true,
	function () sysEngines.ovhtFireTestSwitch:repeatOff() end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(IndirectProcedureItem:new("ENGINES #exchange|EXT|Extinguischer# TEST SWITCH","TEST 1 TO LEFT",FlowItem.actorFO,2,"eng_ext_test_1",
	function () return get("laminar/B738/toggle_switch/extinguisher_circuit_test") < 0 end,
	function () command_begin("laminar/B738/toggle_switch/exting_test_lft") end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(IndirectProcedureItem:new("ENGINES #exchange|EXT|Extinguischer# TEST SWITCH","TEST 2 TO RIGHT",FlowItem.actorFO,2,"eng_ext_test_2",
	function () return get("laminar/B738/toggle_switch/extinguisher_circuit_test") > 0 end,
	function () command_end("laminar/B738/toggle_switch/exting_test_lft") 
				command_begin("laminar/B738/toggle_switch/exting_test_rgt") end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("#spell|APU#","START",FlowItem.actorFO,2,
	function () return sysElectric.apuRunningAnc:getStatus() == modeOn end,
	function () command_end("laminar/B738/toggle_switch/exting_test_rgt") 
				command_once("laminar/B738/spring_toggle_switch/APU_start_pos_dn")
				command_begin("laminar/B738/spring_toggle_switch/APU_start_pos_dn") end,
...
preflightFOProc:addItem(SimpleProcedureItem:new("  Hold APU switch in START position for 3-4 seconds.",
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(IndirectProcedureItem:new("#spell|APU# GEN OFF BUS LIGHT","ILLUMINATED",FlowItem.actorFO,1,"apu_gen_bus_off",
	function () return sysElectric.apuGenBusOff:getStatus() == modeOn end,
	function () command_end("laminar/B738/spring_toggle_switch/APU_start_pos_dn") end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("#spell|APU# GENERATOR BUS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysElectric.apuGenBusOff:getStatus() == 0 end,
	function () sysElectric.apuGenBus1:actuate(1) sysElectric.apuGenBus2:actuate(1) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("TRANSFER BUS LIGHTS","CHECK EXTINGUISHED",FlowItem.actorFO,2,
	function () return sysElectric.transferBus1:getStatus() == modeOff and sysElectric.transferBus2:getStatus() == modeOff end))
...
preflightFOProc:addItem(ProcedureItem:new("FASTEN BELTS SWITCH","ON OR AUTO",FlowItem.actorFO,2,
...
preflightFOProc:addItem(IndirectProcedureItem:new("WINDOW HEAT ANNUNCIATORS","ILLUMINATED",FlowItem.actorFO,2,"towindowheat",
...
preflightFOProc:addItem(ProcedureItem:new("ENGINE HYDRAULIC PUMPS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysHydraulic.engHydPumpGroup:getStatus() == 2 end,
	function () sysHydraulic.engHydPumpGroup:actuate(1) end))
preflightFOProc:addItem(ProcedureItem:new("ELECTRIC HYDRAULIC PUMPS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysHydraulic.elecHydPumpGroup:getStatus() == 2 end,
	function () sysHydraulic.elecHydPumpGroup:actuate(modeOn) end))
...
preflightFOProc:addItem(ProcedureItem:new("AIR TEMPERATURE SOURCE SELECTOR","FWD CAB",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("CABIN TEMPERATURE SELECTORS","AUTO OR AS NEEDED",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("TRIM AIR SWITCH","ON",FlowItem.actorFO,2,
	function () return sysAir.trimAirSwitch:getStatus() == modeOn end,
	function () sysAir.trimAirSwitch:actuate(modeOn) end))
preflightFOProc:addItem(ProcedureItem:new("RECIRCULATION FAN SWITCHES","AUTO",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("AIR CONDITIONING PACK SWITCHES","AUTO OR HIGH",FlowItem.actorFO,2,
	function () return sysAir.packSwitchGroup:getStatus() > 0 end,
	function () sysAir.packSwitchGroup:setValue(sysAir.packModeAuto) end))
preflightFOProc:addItem(ProcedureItem:new("ISOLATION VALVE SWITCH","AUTO OR OPEN",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("ENGINE BLEED AIR SWITCHES","ON",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("APU BLEED AIR SWITCH","ON",FlowItem.actorFO,2,
	function () return sysAir.apuBleedSwitch:getStatus() == modeOn end,
	function () sysAir.apuBleedSwitch:actuate(modeOn) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
preflightFOProc:addItem(ProcedureItem:new("APU BLEED AIR SWITCH","OFF",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("FLIGHT ALTITUDE INDICATOR","%i FT|activeBriefings:get(\"flight:cruiseLevel\")*100",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("LANDING ALTITUDE INDICATOR","%i FT|kc_round_step(get(\"sim/cockpit2/autopilot/altitude_readout_preselector\"),50)",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("PRESSURIZATION MODE SELECTOR","AUTO",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("LANDING LIGHT SWITCHES","RETRACT AND OFF",FlowItem.actorFO,2,
	function () return sysLights.landLightGroup:getStatus() == 0 end,
	function () sysLights.landLightGroup:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("RUNWAY TURNOFF LIGHT SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysLights.rwyLightGroup:getStatus() == 0 end,
	function () sysLights.rwyLightGroup:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("TAXI LIGHT SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysLights.taxiSwitch:getStatus() == 0 end,
	function () sysLights.taxiSwitch:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("LOGO LIGHT SWITCH","%s|(kc_is_daylight()) and \"OFF\" or \"ON\"",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("POSITION LIGHT SWITCH","ON",FlowItem.actorFO,2,
	function () return sysLights.positionSwitch:getStatus() ~= 0  end,
	function () sysLights.positionSwitch:actuate(1) end))
preflightFOProc:addItem(ProcedureItem:new("ANTI-COLLISION LIGHT SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysLights.beaconSwitch:getStatus() == 0 end,
	function () sysLights.beaconSwitch:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("WING ILLUMINATION SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysLights.wingSwitch:getStatus() == 0 end,
	function () sysLights.wingSwitch:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("WHEEL WELL LIGHT SWITCH","%s|(kc_is_daylight()) and \"OFF\" or \"ON\"",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("IGNITION SELECT SWITCH","IGN L OR R",FlowItem.actorFO,2,
	function () return sysEngines.ignSelectSwitch:getStatus() ~= 0 end))
preflightFOProc:addItem(ProcedureItem:new("ENGINE START SWITCHES","OFF",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("COURSE NAV2","SET %s|activeBriefings:get(\"takeoff:crs2\")",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("FLIGHT DIRECTOR SWITCHES","ON, LEFT MASTER",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("MINIMUMS REFERENCE SELECTOR","%s|(activePrefSet:get(\"aircraft:efis_mins_dh\")) and \"RADIO\" or \"BARO\"",FlowItem.actorFO,1,
...
preflightFOProc:addItem(ProcedureItem:new("METERS SWITCH","%s|(activePrefSet:get(\"aircraft:efis_mtr\")) and \"MTRS\" or \"FEET\"",FlowItem.actorFO,1,
	function () 
...
preflightFOProc:addItem(ProcedureItem:new("VOR/ADF SWITCHES","AS NEEDED",FlowItem.actorFO,1,
...
preflightFOProc:addItem(ProcedureItem:new("MODE SELECTOR","MAP",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("CENTER SWITCH","OFF",FlowItem.actorFO,1,
	function () return sysEFIS.ctrCopilot:getStatus() == 1 end))
preflightFOProc:addItem(ProcedureItem:new("RANGE SELECTOR","10 NM",FlowItem.actorFO,1,
...
preflightFOProc:addItem(ProcedureItem:new("TRAFFIC SWITCH","ON",FlowItem.actorFO,1,
	function () return sysEFIS.tfcCopilot:getStatus() == modeOn end,
	function () sysEFIS.tfcCopilot:actuate(modeOn) end))
preflightFOProc:addItem(ProcedureItem:new("WEATHER RADAR","OFF",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("CLOCK","SET LOCAL TIME",FlowItem.actorFO,1,
	function() return sysGeneral.clockDispModeFO:getStatus() == 3 end,
	function () sysGeneral.clockDispModeFO:actuate(3) end))
preflightFOProc:addItem(ProcedureItem:new("MAIN PANEL DISPLAY UNITS SELECTOR","NORM",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("TERRAIN INHIBIT SWITCH","GUARD CLOSED",FlowItem.actorFO,2,
...
preflightFOProc:addItem(ProcedureItem:new("LANDING GEAR LEVER","DN",FlowItem.actorFO,2,
	function () return sysGeneral.GearSwitch:getStatus() == 1 end,
	function () sysGeneral.GearSwitch:actuate(1) end))
preflightFOProc:addItem(ProcedureItem:new("AUTO BRAKE SELECT SWITCH","#spell|RTO#",FlowItem.actorFO,2,
	function () return sysGeneral.autobrake:getStatus() == 0 end,
	function () sysGeneral.autobrake:actuate(0) end))
preflightFOProc:addItem(ProcedureItem:new("ANTISKID INOP LIGHT","VERIFY EXTINGUISHED",FlowItem.actorFO,2,
...
preflightCPTProc:addItem(ProcedureItem:new("LIGHTS TEST","OFF",FlowItem.actorCPT,1,
	function () return sysGeneral.lightTest:getStatus() == 0 end,
	function () kc_speakNoText(0,"test all lights then turn test off") end))
preflightCPTProc:addItem(IndirectProcedureItem:new("OXYGEN","TEST AND SET",FlowItem.actorCPT,2,"oxygentestedcpt",
...
preflightCPTProc:addItem(ProcedureItem:new("VOR/ADF SWITCHES","VOR",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(ProcedureItem:new("CENTER SWITCH","OFF",FlowItem.actorCPT,1,
	function () return sysEFIS.ctrPilot:getStatus() == 1 end))
preflightCPTProc:addItem(ProcedureItem:new("RANGE SELECTOR","10 MILES",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(ProcedureItem:new("TRAFFIC SWITCH","ON",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(ProcedureItem:new("COURSE NAV 1","SET %s|activeBriefings:get(\"takeoff:crs1\")",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(ProcedureItem:new("FLIGHT DIRECTOR SWITCHES","ON, LEFT MASTER",FlowItem.actorCPT,2,
	function () return sysMCP.fdirGroup:getStatus() == 2 and get("laminar/B738/autopilot/master_capt_status") == 1 end,
	function () sysMCP.fdirGroup:actuate(1) end))
...
preflightCPTProc:addItem(ProcedureItem:new("CLOCK","SET UTC",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(ProcedureItem:new("LOWER DISPLAY UNIT SELECTOR","NORM",FlowItem.actorCPT,2,
...
preflightCPTProc:addItem(ProcedureItem:new("PARKING BRAKE","SET",FlowItem.actorCPT,1,
...
preflightCPTProc:addItem(IndirectProcedureItem:new("CARGO FIRE TEST","PERFORM",FlowItem.actorCPT,1,"cargofiretest",
...
preflightChkl:addItem(ChecklistItem:new("WINDOW HEAT","ON",FlowItem.actorFO,1,
	function () return sysAice.windowHeatGroup:getStatus() == 4 end,
	function () sysAice.windowHeatGroup:actuate(1) end))
preflightChkl:addItem(ChecklistItem:new("PRESSURIZATION MODE SELECTOR","AUTO",FlowItem.actorFO,1,
	function () return sysAir.pressModeSelector:getStatus() == 0 end,
	function () sysAir.pressModeSelector:actuate(0) end))
preflightChkl:addItem(ChecklistItem:new("FLIGHT INSTRUMENTS","HEADING %i, ALTIMETER %i|math.floor(get(\"sim/cockpit2/gauges/indicators/heading_electric_deg_mag_pilot\"))|math.floor(get(\"laminar/B738/autopilot/altitude\"))",FlowItem.actorBOTH,6,true,nil,nil))
preflightChkl:addItem(ChecklistItem:new("PARKING BRAKE","SET",FlowItem.actorCPT,1,
	function () return sysGeneral.parkBrakeSwitch:getStatus() == 1 end,
	function () sysGeneral.parkBrakeSwitch:actuate(1) end))
preflightChkl:addItem(ChecklistItem:new("ENGINE START LEVERS","CUTOFF",FlowItem.actorCPT,1,
...
beforeStartProc:addItem(ProcedureItem:new("  LEFT AND RIGHT CENTER FUEL PUMPS SWITCHES","OFF",FlowItem.actorFO,2,
...
beforeStartProc:addItem(ProcedureItem:new("  STABILIZER TRIM","%4.2f UNITS (%4.2f)|kc_round_step((8.2-(get(\"sim/flightmodel2/controls/elevator_trim\")/-0.119)+0.4)*10000,100)/10000|activeBriefings:get(\"takeoff:elevatorTrim\")",FlowItem.actorCPT,1,
...
beforeStartProc:addItem(ProcedureItem:new("WING #exchange|&|and# WHEEL WELL LIGHTS","OFF",FlowItem.actorFO,2,
...
beforeStartChkl:addItem(ChecklistItem:new("#exchange|FLIGHT DECK DOOR|before start checklist. FLIGHT DECK DOOR","CLOSED AND LOCKED",FlowItem.actorFO,2,
	function () return sysGeneral.cockpitDoor:getStatus() == 0 end,
	function () sysGeneral.cockpitDoor:actuate(0) end))
beforeStartChkl:addItem(ChecklistItem:new("FUEL","%i %s, PUMPS ON|activePrefSet:get(\"general:weight_kgs\") and sysFuel.allTanksKgs:getStatus() or sysFuel.allTanksLbs:getStatus()|activePrefSet:get(\"general:weight_kgs\") and \"KGS\" or \"LBS\"",FlowItem.actorFO,1,
	function () return sysFuel.wingFuelPumpGroup:getStatus() == 4 end,
	function () sysFuel.wingFuelPumpGroup:actuate(1) end,
...
beforeStartChkl:addItem(ChecklistItem:new("FUEL","%i %s, PUMPS ON|activePrefSet:get(\"general:weight_kgs\") and sysFuel.allTanksKgs:getStatus() or sysFuel.allTanksLbs:getStatus()|activePrefSet:get(\"general:weight_kgs\") and \"KGS\" or \"LBS\"",FlowItem.actorFO,1,
	...
	function () return sysFuel.centerTankLbs:getStatus() < 1000 end))
beforeStartChkl:addItem(ChecklistItem:new("PASSENGER SIGNS","SET",FlowItem.actorFO,2,
...
beforeStartChkl:addItem(ChecklistItem:new("WINDOWS","LOCKED",FlowItem.actorBOTH,2,true))
beforeStartChkl:addItem(ChecklistItem:new("MCP","V2 %i, HDG %i, ALT %i|activeBriefings:get(\"takeoff:v2\")|activeBriefings:get(\"departure:initHeading\")|activeBriefings:get(\"departure:initAlt\")",FlowItem.actorCPT,2,
...
beforeStartChkl:addItem(ChecklistItem:new("TAKEOFF SPEEDS","V1 %i, VR %i, V2 %i|activeBriefings:get(\"takeoff:v1\")|activeBriefings:get(\"takeoff:vr\")|activeBriefings:get(\"takeoff:v2\")",FlowItem.actorPF,2))
beforeStartChkl:addItem(ChecklistItem:new("CDU PREFLIGHT","COMPLETED",FlowItem.actorPF,1))
...
beforeStartChkl:addItem(ChecklistItem:new("TAXI AND TAKEOFF BRIEFING","COMPLETED",FlowItem.actorPF,1))
beforeStartChkl:addItem(ChecklistItem:new("ANTI-COLLISION LIGHT SWITCH","ON",FlowItem.actorFO,2,
	function () return sysLights.beaconSwitch:getStatus() == 1 end,
	function () sysLights.beaconSwitch:actuate(1) end))
...
pushstartProc:addItem(IndirectProcedureItem:new("PARKING BRAKE","SET",FlowItem.actorCPT,2,"pb_parkbrk_initial_set",
	function () return sysGeneral.parkBrakeSwitch:getStatus() == 1 end,
...
pushstartProc:addItem(ProcedureItem:new("PACKS","OFF",FlowItem.actorFO,2,
...
pushstartProc:addItem(IndirectProcedureItem:new("  ENGINE START SWITCH","START SWITCH %s TO GRD|activeBriefings:get(\"taxi:startSequence\") == 1 and \"2\" or \"1\"",FlowItem.actorCPT,2,"eng_start_1_grd",
...
pushstartProc:addItem(ProcedureItem:new("  N2 ROTATION","AT 25%",FlowItem.actorCPT,1,
	function () if activeBriefings:get("taxi:startSequence") == 1 then
...
pushstartProc:addItem(IndirectProcedureItem:new("  ENGINE START LEVER","LEVER %s IDLE|activeBriefings:get(\"taxi:startSequence\") == 1 and \"2\" or \"1\"",FlowItem.actorCPT,2,"eng_start_1_lever",
	function () if activeBriefings:get("taxi:startSequence") == 1 then
...
pushstartProc:addItem(ProcedureItem:new("STARTER CUTOUT","ANNOUNCE",FlowItem.actorFO,1,
	function () if activeBriefings:get("taxi:startSequence") == 1 then
		return sysEngines.engStart2Switch:getStatus() == 1 else 
		return sysEngines.engStart1Switch:getStatus() == 1 end end))
pushstartProc:addItem(ProcedureItem:new("START SECOND ENGINE","START ENGINE %s|activeBriefings:get(\"taxi:startSequence\") == 1 and \"1\" or \"2\"",FlowItem.actorCPT,1, true,
	function () kc_speakNoText(0,"starter cutout") end))
pushstartProc:addItem(IndirectProcedureItem:new("  ENGINE START SWITCH","START SWITCH %s TO GRD|activeBriefings:get(\"taxi:startSequence\") == 1 and \"1\" or \"2\"",FlowItem.actorCPT,2,"eng_start_2_grd",
	function () if activeBriefings:get("taxi:startSequence") == 1 then
...
pushstartProc:addItem(IndirectProcedureItem:new("  ENGINE START LEVER","LEVER %s IDLE|activeBriefings:get(\"taxi:startSequence\") == 1 and \"1\" or \"2\"",FlowItem.actorCPT,2,"eng_start_2_lever",
	function () if activeBriefings:get("taxi:startSequence") == 1 then
...
pushstartProc:addItem(ProcedureItem:new("  TOW BAR DISCONNECTED","VERIFY",FlowItem.actorCPT,1,true,
	function () kc_speakNoText(0,"starter cutout") end))
pushstartProc:addItem(ProcedureItem:new("  LOCKOUT PIN REMOVED","VERIFY",FlowItem.actorCPT,1))
pushstartProc:addItem(ProcedureItem:new("PARKING BRAKE","SET",FlowItem.actorFO,2,
	function () return sysGeneral.parkBrakeSwitch:getStatus() == 1 end,
...
beforeTaxiProc:addItem(ProcedureItem:new("HYDRAULIC PUMP SWITCHES","ALL ON",FlowItem.actorFO,1,
...
beforeTaxiProc:addItem(ProcedureItem:new("WING ANTI-ICE SWITCH","OFF",FlowItem.actorFO,1,
	function () return sysAice.wingAntiIce:getStatus() == 0 end,
	function () sysAice.wingAntiIce:actuate(0) end,
	function () return activeBriefings:get("takeoff:antiice") == 3 end))
beforeTaxiProc:addItem(ProcedureItem:new("WING ANTI-ICE SWITCH","ON",FlowItem.actorFO,1,
	function () return sysAice.wingAntiIce:getStatus() == 1 end,
	function () sysAice.wingAntiIce:actuate(1) end,
	function () return activeBriefings:get("takeoff:antiice") < 3 end))
beforeTaxiProc:addItem(ProcedureItem:new("ENGINE ANTI-ICE SWITCHES","OFF",FlowItem.actorFO,1,
	function () return sysAice.engAntiIceGroup:getStatus() == 0 end,
	function () sysAice.engAntiIceGroup:actuate(0) end,
	function () return activeBriefings:get("takeoff:antiice") > 1 end))
beforeTaxiProc:addItem(ProcedureItem:new("ENGINE ANTI-ICE SWITCHES","ON",FlowItem.actorFO,1,
...
beforeTaxiProc:addItem(ProcedureItem:new("FLAP LEVER","SET TAKEOFF FLAPS %s|kc_pref_split(kc_TakeoffFlaps)[activeBriefings:get(\"takeoff:flaps\")]",FlowItem.actorFO,1,
...
beforeTaxiProc:addItem(ProcedureItem:new("LE FLAPS EXT GREEN LIGHT","ILLUMINATED",FlowItem.actorFO,1,
	function () return get("laminar/B738/annunciator/slats_extend") == 1 end))
beforeTaxiProc:addItem(IndirectProcedureItem:new("FLIGHT CONTROLS","CHECK",FlowItem.actorBOTH,1,"fccheck",
...
beforeTaxiChkl:addItem(ChecklistItem:new("#exchange|GENERATORS|before taxi checklist. generators","ON",FlowItem.actorFO,1,
	function () return sysElectric.gen1off:getStatus() == 0 and sysElectric.gen2off:getStatus() == 0 end))
beforeTaxiChkl:addItem(ChecklistItem:new("PROBE HEAT","ON",FlowItem.actorFO,2,
	function () return sysAice.probeHeatGroup:getStatus() == 2 end,
	function () sysAice.probeHeatGroup:actuate(1) end))
beforeTaxiChkl:addItem(ChecklistItem:new("ANTI-ICE","OFF",FlowItem.actorFO,1,
	...
	function () return activeBriefings:get("takeoff:antiice") ~= 1 end))
beforeTaxiChkl:addItem(ChecklistItem:new("ANTI-ICE","ENGINE ANTI-ICE",FlowItem.actorFO,1,
...
beforeTaxiChkl:addItem(ChecklistItem:new("ANTI-ICE","ENGINE & WING ANTI-ICE",FlowItem.actorFO,1,
	...
	function () return activeBriefings:get("takeoff:antiice") ~= 3 end))
beforeTaxiChkl:addItem(ChecklistItem:new("ISOLATION VALVE","AUTO",FlowItem.actorFO,2,
	function () return sysAir.isoValveSwitch:getStatus() > 0 end,
	function () sysAir.isoValveSwitch:setValue(sysAir.isoVlvAuto) end))
beforeTaxiChkl:addItem(ChecklistItem:new("ENGINE START SWITCHES","CONT",FlowItem.actorCPT,2,
	function () return sysEngines.engStarterGroup:getStatus() == 4 end,
	function () sysEngines.engStarterGroup:actuate(2) end)) 
beforeTaxiChkl:addItem(ChecklistItem:new("RECALL","CHECKED",FlowItem.actorCPT,1,
	function() return sysGeneral.annunciators:getStatus() == 0 end,
	function() command_once("laminar/B738/push_button/capt_six_pack") end))
beforeTaxiChkl:addItem(ChecklistItem:new("AUTOBRAKE","RTO",FlowItem.actorCPT,2,
	function () return sysGeneral.autobrake:getStatus() == 0 end,
	function () sysGeneral.autobrake:actuate(0) end))
beforeTaxiChkl:addItem(ChecklistItem:new("ENGINE START LEVERS","IDLE DETENT",FlowItem.actorCPT,2,
	function () return sysEngines.startLeverGroup:getStatus() == 2 end))
beforeTaxiChkl:addItem(IndirectChecklistItem:new("FLIGHT CONTROLS","CHECK",FlowItem.actorCPT,1,"fccheck",
function () return get("sim/flightmodel2/wing/rudder1_deg") > 18 end))
beforeTaxiChkl:addItem(ChecklistItem:new("GROUND EQUIPMENT","CLEAR",FlowItem.actorFO,1,true,
...
beforeTakeoffChkl:addItem(ChecklistItem:new("#exchange|FLAPS|before takeoff checklist. Flaps","%s, GREEN LIGHT|kc_pref_split(kc_TakeoffFlaps)[activeBriefings:get(\"takeoff:flaps\")]",FlowItem.actorCPT,1,
	...
	function () sysControls.flapsSwitch:setValue(sysControls.flaps_pos[activeBriefings:get("takeoff:flaps")]) end)) 
beforeTakeoffChkl:addItem(ChecklistItem:new("STABILIZER TRIM","%3.2f UNITS (%3.2f)|kc_round_step((8.2-(get(\"sim/flightmodel2/controls/elevator_trim\")/-0.119)+0.4)*1000,10)/1000|activeBriefings:get(\"takeoff:elevatorTrim\")",FlowItem.actorCPT,1,
...
runwayEntryProc:addItem(ProcedureItem:new("STROBES","ON",FlowItem.actorFO,2,
...
runwayEntryProc:addItem(ProcedureItem:new("RWY TURNOFF LIGHTS","ON",FlowItem.actorCPT,2,
	function () return sysLights.rwyLightGroup:getStatus() > 0 end,
	function () sysLights.rwyLightGroup:actuate(1) end))
runwayEntryProc:addItem(ProcedureItem:new("TAXI LIGHTS","OFF",FlowItem.actorCPT,2,
	function () return sysLights.taxiSwitch:getStatus() == 0 end,
	function () sysLights.taxiSwitch:actuate(0) end))
...
takeoffClimbProc:addItem(ProcedureItem:new("AUTOTHROTTLE","ARM",FlowItem.actorPF,2,
	function () return sysMCP.athrSwitch:getStatus() == 1 end,
...
takeoffClimbProc:addItem(ProcedureItem:new("A/P MODES","%s|kc_pref_split(kc_TakeoffApModes)[activeBriefings:get(\"takeoff:apMode\")]",FlowItem.actorPF,2,
	function () 
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("THRUST SETTING","40% N1",FlowItem.actorPNF,1,"to40percent",
	function () return get("laminar/B738/engine/indicators/N1_percent_1") > 40 end))
takeoffClimbProc:addItem(ProcedureItem:new("SET TAKEOFF THRUST","T/O MODE",FlowItem.actorPF,2,
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("POSITIVE RATE","GT 40 FT AGL",FlowItem.actorPNF,2,"toposrate",
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("GEAR","UP",FlowItem.actorPF,2,"gear_up_to",
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("FLAPS 15 SPEED","REACHED",FlowItem.actorPNF,2,"toflap15spd",
...
takeoffClimbProc:addItem(ProcedureItem:new("FLAPS 10","SET",FlowItem.actorPNF,2,
	...
	function () return sysControls.flapsSwitch:getStatus() < 0.5 end))
takeoffClimbProc:addItem(IndirectProcedureItem:new("FLAPS 10 SPEED","REACHED",FlowItem.actorPNF,2,"toflap10spd",
	function () return get("sim/cockpit2/gauges/indicators/airspeed_kts_pilot") > get("laminar/B738/pfd/flaps_10") end,nil,
	function () return sysControls.flapsSwitch:getStatus() < 0.5 end))
takeoffClimbProc:addItem(ProcedureItem:new("FLAPS 5","SET",FlowItem.actorPNF,2,
	...
	function () return sysControls.flapsSwitch:getStatus() < 0.375 end))
takeoffClimbProc:addItem(IndirectProcedureItem:new("FLAPS 5 SPEED","REACHED",FlowItem.actorPNF,2,"toflap5spd",
	function () return get("sim/cockpit2/gauges/indicators/airspeed_kts_pilot") > get("laminar/B738/pfd/flaps_5") end,nil,
	function () return sysControls.flapsSwitch:getStatus() < 0.375 end))
takeoffClimbProc:addItem(ProcedureItem:new("FLAPS 1","SET",FlowItem.actorPNF,2,
	...
	function () return sysControls.flapsSwitch:getStatus() < 0.125 end))
takeoffClimbProc:addItem(IndirectProcedureItem:new("FLAPS 1 SPEED","REACHED",FlowItem.actorPNF,2,"toflap1spd",
	function () return get("sim/cockpit2/gauges/indicators/airspeed_kts_pilot") > get("laminar/B738/pfd/flaps_1") end))
takeoffClimbProc:addItem(ProcedureItem:new("FLAPS UP","SET",FlowItem.actorPNF,2,
	function () return sysControls.flapsSwitch:getStatus() == 0 end,
	function () command_once("laminar/B738/push_button/flaps_0") kc_speakNoText(0,"speed check flaps up") end))
takeoffClimbProc:addItem(IndirectProcedureItem:new("ACCELERATION ALTITUDE","GT 300 FT AGL",FlowItem.actorPNF,2,"toaccalt",
	function () return get("sim/flightmodel/position/y_agl") > 300 end))
takeoffClimbProc:addItem(ProcedureItem:new("CMD-A","ON",FlowItem.actorPF,2,
...
takeoffClimbProc:addItem(ProcedureItem:new("AUTO BRAKE SELECT SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysGeneral.autobrake:getStatus() == 1 end,
	function () command_once("laminar/B738/knob/autobrake_off") end))
takeoffClimbProc:addItem(ProcedureItem:new("GEAR","OFF",FlowItem.actorPF,2,
	function () return sysGeneral.GearSwitch:getStatus() == 0.5 end,
	function () command_once("laminar/B738/push_button/gear_off") end))
	
takeoffClimbProc:addItem(IndirectProcedureItem:new("TRANSITION ALTITUDE","REACHED",FlowItem.actorPF,2,"to_trans_alt",
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("ALTIMETERS","STD",FlowItem.actorPF,2,"to_altimeters",
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("10.000 FT","REACHED",FlowItem.actorPF,2,"to_10000",
	function () return get("sim/cockpit2/gauges/indicators/altitude_ft_pilot") > 10000 end,nil,
	function () return activeBriefings:get("departure:transalt") <= 10000 end))
takeoffClimbProc:addItem(ProcedureItem:new("LANDING LIGHTS","OFF",FlowItem.actorPM,2,
	function () return sysLights.landLightGroup:getStatus() == 0 end,
	function () sysLights.landLightGroup:actuate(0)  kc_speakNoText(0,"ten thousand") end,
	function () return activeBriefings:get("departure:transalt") <= 10000 end))
takeoffClimbProc:addItem(ProcedureItem:new("RUNWAY TURNOFF LIGHT SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysLights.rwyLightGroup:getStatus() == 0 end,
	function () sysLights.rwyLightGroup:actuate(0) end,
	function () return activeBriefings:get("departure:transalt") <= 10000 end))
takeoffClimbProc:addItem(ProcedureItem:new("FASTEN BELTS SWITCH","OFF",FlowItem.actorPM,2,
	function () return sysGeneral.seatBeltSwitch:getStatus() == 0 end,
	function () 
		command_once("laminar/B738/toggle_switch/seatbelt_sign_up") 
		command_once("laminar/B738/toggle_switch/seatbelt_sign_up") 
...
takeoffClimbProc:addItem(IndirectProcedureItem:new("ALTIMETERS","STD",FlowItem.actorPF,2,"to_altimeters",
	...
	function () return activeBriefings:get("departure:transalt") <= 10000 end))
takeoffClimbProc:addItem(ProcedureItem:new("ENGINE START SWITCHES","OFF",FlowItem.actorPM,1,
	function () return sysEngines.engStarterGroup:getStatus() == 2 end,
	function () sysEngines.engStarterGroup:actuate(1) end))
...
afterTakeoffChkl:addItem(ChecklistItem:new("#exchange|ENGINE BLEEDS|after takeoff checklist. engine bleeds","ON",FlowItem.actorPM,2,
	function () return sysAir.engBleedGroup:getStatus() == 2 end,
	function () sysAir.engBleedGroup:actuate(1) end))
afterTakeoffChkl:addItem(ChecklistItem:new("PACKS","AUTO",FlowItem.actorPM,2,
	function () return sysAir.packSwitchGroup:getStatus() == 2 end,
	function () sysAir.packSwitchGroup:setValue(sysAir.packModeAuto) end))
afterTakeoffChkl:addItem(ChecklistItem:new("LANDING GEAR","UP AND OFF",FlowItem.actorPM,2,
	function () return sysGeneral.GearSwitch:getStatus() == 0.5 end,
	function () sysGeneral.GearSwitch:actuate(2) end))
afterTakeoffChkl:addItem(ChecklistItem:new("FLAPS","UP, NO LIGHTS",FlowItem.actorPM,2,
...
descentProc:addItem(ProcedureItem:new("LEFT AND RIGHT CENTER FUEL PUMPS SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysFuel.ctrFuelPumpGroup:getStatus() == 0 end,
	function () sysFuel.ctrFuelPumpGroup:actuate(0) end,
...
descentProc:addItem(SimpleProcedureItem:new("  If center tank quantity at or below 3,000 lbs/1400 kgs",
	function () return sysFuel.centerTankLbs:getStatus() > 3000 end))
descentProc:addItem(ProcedureItem:new("PRESSURIZATION","LAND ALT %i FT|activeBriefings:get(\"arrival:aptElevation\")",FlowItem.actorPM,1,
...
descentProc:addItem(ProcedureItem:new("RECALL","CHECKED ALL OFF",FlowItem.actorPM,1,
	function() return sysGeneral.annunciators:getStatus() == 0 end,
	function() command_once("laminar/B738/push_button/capt_six_pack") end))
descentProc:addItem(ProcedureItem:new("VREF","SELECT IN FMC",FlowItem.actorCPT,1,
	function () return get("laminar/B738/FMS/vref") ~= 0 end))
descentProc:addItem(ProcedureItem:new("LANDING DATA","VREF %i, MINIMUMS %i|get(\"laminar/B738/FMS/vref\")|activeBriefings:get(\"approach:decision\")",FlowItem.actorBOTH,1,
...
descentProc:addItem(ProcedureItem:new("AUTO BRAKE SELECT SWITCH","%s|kc_pref_split(kc_LandingAutoBrake)[activeBriefings:get(\"approach:autobrake\")]",FlowItem.actorFO,2,
...
descentChkl:addItem(ChecklistItem:new("#exchange|PRESSURIZATION|descent checklist. pressurization","LAND ALT %i FT|activeBriefings:get(\"arrival:aptElevation\")",FlowItem.actorPM,1,
	function () return sysAir.landingAltitude:getStatus() == kc_round_step(activeBriefings:get("arrival:aptElevation"),50) end,
	function () sysAir.landingAltitude:setValue(kc_round_step(activeBriefings:get("arrival:aptElevation"),50)) end))
descentChkl:addItem(ChecklistItem:new("RECALL","CHECKED",FlowItem.actorBOTH,1,
	function() return sysGeneral.annunciators:getStatus() == 0 end,
	function() command_once("laminar/B738/push_button/capt_six_pack") end))
...
arrivalProc:addItem(IndirectProcedureItem:new("10.000 FT","ANNOUNCE REACHED",FlowItem.actorPM,2,"ldg_10000",
	function () return get("sim/cockpit2/gauges/indicators/altitude_ft_pilot") <= 10000 end,nil,
	function () return activeBriefings:get("arrival:translvl") > 100 end))
arrivalProc:addItem(ProcedureItem:new("LANDING LIGHTS","ON",FlowItem.actorPM,2,
	function () return sysLights.landLightGroup:getStatus() > 0 end,
	function () sysLights.landLightGroup:actuate(1)  kc_speakNoText(0,"ten thousand") end,
	function () return activeBriefings:get("arrival:translvl") > 100 end))
arrivalProc:addItem(ProcedureItem:new("FASTEN BELTS SWITCH","ON",FlowItem.actorPM,2,
	function () return sysGeneral.seatBeltSwitch:getStatus() > 0 end,
	function () 
		command_once("laminar/B738/toggle_switch/seatbelt_sign_up") 
		command_once("laminar/B738/toggle_switch/seatbelt_sign_up") 
...
arrivalProc:addItem(IndirectProcedureItem:new("TRANSITION LEVEL","ANNOUNCE REACHED",FlowItem.actorPM,2,"ldg_trans_lvl",
...
arrivalProc:addItem(ProcedureItem:new("AUTO BRAKE SELECT SWITCH","%s|kc_pref_split(kc_LandingAutoBrake)[activeBriefings:get(\"approach:autobrake\")]",FlowItem.actorFO,2,
	function () return sysGeneral.autobrake:getStatus() == activeBriefings:get("approach:autobrake") end,
	function () 
		if activeBriefings:get("approach:autobrake") == 2 then
			command_once("laminar/B738/knob/autobrake_1")
...
arrivalProc:addItem(ProcedureItem:new("LOGO LIGHT SWITCH","%s|(kc_is_daylight()) and \"OFF\" or \"ON\"",FlowItem.actorFO,2,
	function () return sysLights.logoSwitch:getStatus() == (kc_is_daylight() and 0 or 1) end,
	function () sysLights.logoSwitch:actuate( kc_is_daylight() and 0 or 1) end ))
...
landingProc:addItem(ProcedureItem:new("LANDING LIGHTS","ON",FlowItem.actorCPT,2,
	function () return sysLights.landLightGroup:getStatus() > 1 end,
	function () sysLights.landLightGroup:actuate(1) end))
landingProc:addItem(ProcedureItem:new("RWY TURNOFF LIGHTS","ON",FlowItem.actorCPT,2,
	function () return sysLights.rwyLightGroup:getStatus() > 0 end,
	function () sysLights.rwyLightGroup:actuate(1) end))
landingProc:addItem(ProcedureItem:new("ENGINE START SWITCHES","CONT",FlowItem.actorPM,2,
	function () return sysEngines.engStarterGroup:getStatus() == 4 end,
	function () sysEngines.engStarterGroup:actuate(2) end)) 
landingProc:addItem(ProcedureItem:new("SPEED BRAKE","ARMED",FlowItem.actorPF,1,
	function () return get("laminar/B738/annunciator/speedbrake_armed") == 1 end,
	function () kc_speakNoText(0,"Speed brake armed?") end))
landingProc:addItem(ProcedureItem:new("COURSE NAV 1","SET %s|activeBriefings:get(\"approach:nav1Course\")",FlowItem.actorCPT,1,
...
landingProc:addItem(ProcedureItem:new("COURSE NAV2","SET %s|activeBriefings:get(\"approach:nav2Course\")",FlowItem.actorFO,2,
...
landingProc:addItem(ProcedureItem:new("GO AROUND ALTITUDE","SET %s|activeBriefings:get(\"approach:gaaltitude\")",FlowItem.actorPM,2,
...
landingChkl:addItem(ChecklistItem:new("#exchange|ENGINE START SWITCHES|landing checklist. ENGINE START SWITCHES","CONT",FlowItem.actorPF,2,
	function () return sysEngines.engStarterGroup:getStatus() == 4 end,
	function () sysEngines.engStarterGroup:actuate(2) end)) 
landingChkl:addItem(ChecklistItem:new("SPEED BRAKE","ARMED",FlowItem.actorPF,1,
	function () return get("laminar/B738/annunciator/speedbrake_armed") == 1 end))
landingChkl:addItem(ChecklistItem:new("LANDING GEAR","DOWN",FlowItem.actorPF,2,
	function () return sysGeneral.GearSwitch:getStatus() == modeOn end,
	function () sysGeneral.GearSwitch:actuate(modeOn) end))
landingChkl:addItem(ChecklistItem:new("FLAPS","%s, GREEN LIGHT|kc_pref_split(kc_LandingFlaps)[activeBriefings:get(\"approach:flaps\")]",FlowItem.actorPF,2,
...
landingChkl:addItem(ChecklistItem:new("GO AROUND ALTITUDE","SET %s|activeBriefings:get(\"approach:gaaltitude\")",FlowItem.actorPM,2,
	function() return sysMCP.altSelector:getStatus()  == activeBriefings:get("approach:gaaltitude") end,
	function() sysMCP.altSelector:setValue(activeBriefings:get("approach:gaaltitude")) end))
landingChkl:addItem(ChecklistItem:new("GO AROUND HEADING","SET %s|activeBriefings:get(\"approach:gaheading\")",FlowItem.actorPM,2,
	function() return sysMCP.hdgSelector:getStatus() == activeBriefings:get("approach:gaheading") end,
	function() sysMCP.hdgSelector:setValue(activeBriefings:get("approach:gaheading")) end))
...
afterLandingProc:addItem(ProcedureItem:new("SPEED BRAKE","DOWN",FlowItem.actorPF,2,
	function () return sysControls.spoilerLever:getStatus() == 0 end,
...
afterLandingProc:addItem(ProcedureItem:new("WX RADAR","OFF",FlowItem.actorCPT,2,
	function () return sysEFIS.wxrPilot:getStatus() == 0 end,
	function () sysEFIS.wxrPilot:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("PROBE HEAT","OFF",FlowItem.actorFO,2,
	function () return sysAice.probeHeatGroup:getStatus() == 0 end,
	function () sysAice.probeHeatGroup:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("STROBES","OFF",FlowItem.actorFO,2,
	function () return sysLights.strobesSwitch:getStatus() == 0 end,
	function () sysLights.strobesSwitch:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("LANDING LIGHTS","OFF",FlowItem.actorCPT,2,
	function () return sysLights.landLightGroup:getStatus() == 0 end,
	function () sysLights.landLightGroup:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("RWY TURNOFF LIGHTS","OFF",FlowItem.actorCPT,2,
	function () return sysLights.rwyLightGroup:getStatus() == 0 end,
	function () sysLights.rwyLightGroup:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("TAXI LIGHTS","ON",FlowItem.actorCPT,2,
	function () return sysLights.taxiSwitch:getStatus() > 0 end,
	function () sysLights.taxiSwitch:actuate(1) end))
afterLandingProc:addItem(ProcedureItem:new("ENGINE START SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysEngines.engStarterGroup:getStatus() == 2 end,
	function () sysEngines.engStarterGroup:actuate(1) end))
afterLandingProc:addItem(ProcedureItem:new("TRAFFIC SWITCH","OFF",FlowItem.actorFO,1,
	function () return sysEFIS.tfcPilot:getStatus() == 0 end,
	function () sysEFIS.tfcPilot:actuate(0) end))
afterLandingProc:addItem(ProcedureItem:new("AUTOBRAKE","OFF",FlowItem.actorFO,2,
	function () return sysGeneral.autobrake:getStatus() == 1 end,
...
afterLandingProc:addItem(ProcedureItem:new("#spell|APU#","START",FlowItem.actorFO,2,
	function () return sysElectric.apuRunningAnc:getStatus() == modeOn end,
...
afterLandingProc:addItem(SimpleProcedureItem:new("  Hold APU switch in START position for 3-4 seconds.",
	function () return activeBriefings:get("approach:powerAtGate") == 1 end))
afterLandingProc:addItem(IndirectProcedureItem:new("  #spell|APU# GEN OFF BUS LIGHT","ILLUMINATED",FlowItem.actorFO,1,"apu_gen_bus_end",
	function () return sysElectric.apuGenBusOff:getStatus() == modeOn end,
	function () command_end("laminar/B738/spring_toggle_switch/APU_start_pos_dn") end,
	function () return activeBriefings:get("approach:powerAtGate") == 1 end))
...
shutdownProc:addItem(ProcedureItem:new("TAXI LIGHT SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysLights.taxiSwitch:getStatus() == 0 end,
	function () sysLights.taxiSwitch:actuate(0) activeBckVars:set("general:timesON",kc_dispTimeHHMM(get("sim/time/zulu_time_sec"))) end))
shutdownProc:addItem(ProcedureItem:new("PARKING BRAKE","SET",FlowItem.actorCPT,2,
	function () return sysGeneral.parkBrakeSwitch:getStatus() == modeOn end,
	function () sysGeneral.parkBrakeSwitch:actuate(modeOn) end))
shutdownProc:addItem(SimpleChecklistItem:new("==== Electrical power"))
shutdownProc:addItem(ProcedureItem:new("#spell|APU# GENERATOR BUS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysElectric.apuGenBusOff:getStatus() == 0 end,
	function () sysElectric.apuGenBus1:actuate(1) sysElectric.apuGenBus2:actuate(1) end,
	function () return activeBriefings:get("approach:powerAtGate") == 1 end))
shutdownProc:addItem(ProcedureItem:new("  #exchange|GRD|GROUND# POWER AVAILABLE LIGHT","ILLUMINATED",FlowItem.actorFO,2,
	function () return sysElectric.gpuAvailAnc:getStatus() == modeOn end,
	function () 
...
shutdownProc:addItem(ProcedureItem:new("GROUND POWER SWITCH","ON",FlowItem.actorFO,2,
	function () return sysElectric.gpuOnBus:getStatus() == 1 end,
	function () sysElectric.gpuSwitch:actuate(cmdDown) end,
	function () return activeBriefings:get("approach:powerAtGate") == 2 end))
shutdownProc:addItem(ProcedureItem:new("ENGINE START LEVERS","CUTOFF",FlowItem.actorCPT,1,
	function () return sysEngines.startLever1:getStatus() == 0 and sysEngines.startLever2:getStatus() == 0 end,
	function () kc_speakNoText(0,"ready to cut engines") end))
shutdownProc:addItem(ProcedureItem:new("FASTEN BELTS SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysGeneral.seatBeltSwitch:getStatus() == 0 end,
	function () sysGeneral.seatBeltSwitch:actuate(0) end))
shutdownProc:addItem(ProcedureItem:new("ANTI COLLISION LIGHT SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysLights.beaconSwitch:getStatus() == 0 end,
	function () sysLights.beaconSwitch:actuate(0) end))
shutdownProc:addItem(ProcedureItem:new("FUEL PUMPS","APU 1 PUMP ON, REST OFF",FlowItem.actorCPT,2,
	function () return sysFuel.allFuelPumpGroup:getStatus() == 1 end,
	function () sysFuel.allFuelPumpGroup:actuate(modeOff) sysFuel.fuelPumpLeftAft:actuate(modeOn) end,
	function () return activeBriefings:get("approach:powerAtGate") == 1 end))
shutdownProc:addItem(ProcedureItem:new("FUEL PUMPS","ALL OFF",FlowItem.actorFO,2,
	function () return sysFuel.allFuelPumpGroup:getStatus() == 0 end,
	function () sysFuel.allFuelPumpGroup:actuate(modeOff) end,
	function () return activeBriefings:get("approach:powerAtGate") == 2 end))
shutdownProc:addItem(ProcedureItem:new("CAB/UTIL POWER SWITCH","ON",FlowItem.actorCPT,1,
	function () return sysElectric.cabUtilPwr:getStatus() == modeOn end,
	function () sysElectric.cabUtilPwr:actuate(modeOn) end))
shutdownProc:addItem(ProcedureItem:new("IFE/PASS SEAT POWER SWITCH","OFF",FlowItem.actorCPT,1,
	function () return sysElectric.ifePwr:getStatus() == modeOff end,
	function () sysElectric.ifePwr:actuate(modeOff) end))
shutdownProc:addItem(ProcedureItem:new("WING ANTI-ICE SWITCH","OFF",FlowItem.actorFO,2,
	function () return sysAice.wingAntiIce:getStatus() == 0 end,
	function () sysAice.wingAntiIce:actuate(0) end))
shutdownProc:addItem(ProcedureItem:new("ENGINE ANTI-ICE SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysAice.engAntiIceGroup:getStatus() == 0 end,
	function () sysAice.engAntiIceGroup:actuate(0) end))
shutdownProc:addItem(ProcedureItem:new("PROBE HEAT","OFF",FlowItem.actorFO,2,
	function () return sysAice.probeHeatGroup:getStatus() == 0 end,
	function () sysAice.probeHeatGroup:actuate(0) end))
shutdownProc:addItem(ProcedureItem:new("ENGINE HYDRAULIC PUMPS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysHydraulic.engHydPumpGroup:getStatus() == 2 end,
	function () sysHydraulic.engHydPumpGroup:actuate(1) end))
shutdownProc:addItem(ProcedureItem:new("ELECTRIC HYDRAULIC PUMPS SWITCHES","OFF",FlowItem.actorFO,2,
	function () return sysHydraulic.elecHydPumpGroup:getStatus() == 0 end,
	function () sysHydraulic.elecHydPumpGroup:actuate(modeOff) end))
shutdownProc:addItem(ProcedureItem:new("RECIRCULATION FAN SWITCHES","AUTO",FlowItem.actorFO,2,
	function () return sysAir.recircFanLeft:getStatus() == modeOn and sysAir.recircFanRight:getStatus() == modeOn end,
	function () sysAir.recircFanLeft:actuate(modeOn) sysAir.recircFanRight:actuate(modeOn) end))
shutdownProc:addItem(ProcedureItem:new("AIR CONDITIONING PACK SWITCHES","AUTO",FlowItem.actorFO,2,
	function () return sysAir.packSwitchGroup:getStatus() > 1 end,
	function () sysAir.packSwitchGroup:setValue(sysAir.packModeAuto) end))
shutdownProc:addItem(ProcedureItem:new("ISOLATION VALVE SWITCH","OPEN",FlowItem.actorFO,2,
	function () return sysAir.isoValveSwitch:getStatus() == sysAir.isoVlvOpen end,
	function () sysAir.isoValveSwitch:setValue(sysAir.isoVlvOpen) end))
shutdownProc:addItem(ProcedureItem:new("ENGINE BLEED AIR SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysAir.bleedEng1Switch:getStatus() == 1 and sysAir.bleedEng2Switch:getStatus() == 1 end,
	function () sysAir.bleedEng1Switch:actuate(1) sysAir.bleedEng2Switch:actuate(1) end))
shutdownProc:addItem(ProcedureItem:new("APU BLEED AIR SWITCH","ON",FlowItem.actorFO,2,
	function () return sysAir.apuBleedSwitch:getStatus() == modeOn end,
	function () sysAir.apuBleedSwitch:actuate(modeOn) end,
	function () return not activeBriefings:get("approach:powerAtGate") == 1 end))
shutdownProc:addItem(ProcedureItem:new("FLIGHT DIRECTOR SWITCHES","OFF",FlowItem.actorFO,2,
...
shutdownChkl:addItem(ChecklistItem:new("FUEL PUMPS","ONE PUMP ON FOR APU, REST OFF",FlowItem.actorFO,2,
	function () return sysFuel.allFuelPumpGroup:getStatus() == 1 end,
	function () sysFuel.allFuelPumpGroup:actuate(modeOff) sysFuel.fuelPumpLeftAft:actuate(modeOn) end,
	function () return activeBriefings:get("approach:powerAtGate") == 1 end))
shutdownChkl:addItem(ChecklistItem:new("FUEL PUMPS","OFF",FlowItem.actorFO,2,
	function () return sysFuel.allFuelPumpGroup:getStatus() == 0 end,
	function () sysFuel.allFuelPumpGroup:actuate(modeOff) end,
	function () return activeBriefings:get("approach:powerAtGate") == 2 end))
shutdownChkl:addItem(ChecklistItem:new("PROBE HEAT","OFF",FlowItem.actorFO,2,
	function () return sysAice.probeHeatGroup:getStatus() == 0 end,
	function () sysAice.probeHeatGroup:actuate(0) end))
shutdownChkl:addItem(ChecklistItem:new("HYDRAULIC PANEL","SET",FlowItem.actorFO,2))
shutdownChkl:addItem(ChecklistItem:new("FLAPS","UP",FlowItem.actorCPT,2,
	function () return sysControls.flapsSwitch:getStatus() == 0 end,
	function () sysControls.flapsSwitch:setValue(0) end)) 
shutdownChkl:addItem(ChecklistItem:new("PARKING BRAKE","ON",FlowItem.actorCPT,2,
	function () return sysGeneral.parkBrakeSwitch:getStatus() == modeOn end,
	function () sysGeneral.parkBrakeSwitch:actuate(modeOn) end))
shutdownChkl:addItem(ChecklistItem:new("ENGINE START LEVERS","CUTOFF",FlowItem.actorCPT,2,
	function () return sysEngines.startLeverGroup:getStatus() == 0 end,
	function () sysEngines.startLeverGroup:actuate(cmdDown) end))
shutdownChkl:addItem(ChecklistItem:new("WEATHER RADAR","OFF",FlowItem.actorBOTH,2,
	function () return sysEFIS.wxrPilot:getStatus() == 0 end,
	function () sysEFIS.wxrPilot:actuate(0) end))
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD TOP","SET","SYS",1,"c_d_1",
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 1","SET","SYS",1,"c_d_2",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 2","SET","SYS",1,"c_d_3",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 3","SET","SYS",1,"c_d_4",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 4","SET","SYS",1,"c_d_5",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 5","SET","SYS",1,"c_d_6",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("LIGHT PANEL","SET","SYS",1,"c_d_7",
	function () return true end,
	function () 
...
coldAndDarkProc:addItem(IndirectProcedureItem:new("THE REST","SET","SYS",1,"c_d_8",
	function () return true end,
	function () 
...
secureChkl:addItem(ChecklistItem:new("#exchange|IRS MODE SELECTORS|SECURE CHECKLIST. I R S MODE SELECTORS","OFF",FlowItem.actorFO,1,
	function () return sysGeneral.irsUnitGroup:getStatus() == modeOff end,
...
secureChkl:addItem(ChecklistItem:new("PACKS","OFF",FlowItem.actorFO,2,
	function () return sysAir.packSwitchGroup:getStatus() == sysAir.packModeOff end,
	function () sysAir.packSwitchGroup:setValue(sysAir.packModeOff) end))
...
turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD TOP","SET","SYS",1,"c_d_1",
	function () return true end,
	function () 
		sysGeneral.doorL1:actuate(1)
		set("sim/private/controls/shadow/cockpit_near_adjust",0.09)
...
turnAroundProc:addItem(SimpleProcedureItem:new("==== Activate External Power",
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
turnAroundProc:addItem(SimpleProcedureItem:new("  Use Zibo EFB to turn Ground Power on.",
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
turnAroundProc:addItem(ProcedureItem:new("  #exchange|GRD|GROUND# POWER AVAILABLE LIGHT","ILLUMINATED",FlowItem.actorFO,2,
	function () return sysElectric.gpuAvailAnc:getStatus() == modeOn end,
	function () 
		if get("laminar/B738/gpu_available") == 0 then
			command_once("laminar/B738/tab/home")
	...
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))
turnAroundProc:addItem(ProcedureItem:new("  GROUND POWER SWITCH","ON",FlowItem.actorFO,2,
	function () return sysElectric.gpuOnBus:getStatus() == 1 end,
	function () sysElectric.gpuSwitch:actuate(cmdDown) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == true end))

turnAroundProc:addItem(SimpleProcedureItem:new("==== Activate APU",
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
turnAroundProc:addItem(ProcedureItem:new("  #spell|APU#","START",FlowItem.actorFO,2,
	function () return sysElectric.apuRunningAnc:getStatus() == modeOn end,
	function () command_end("laminar/B738/toggle_switch/exting_test_rgt") 
				command_once("laminar/B738/spring_toggle_switch/APU_start_pos_dn")
				command_begin("laminar/B738/spring_toggle_switch/APU_start_pos_dn") end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
turnAroundProc:addItem(IndirectProcedureItem:new("  #spell|APU# GEN OFF BUS LIGHT","ILLUMINATED",FlowItem.actorFO,1,"apu_gen_bus_off",
	function () return sysElectric.apuGenBusOff:getStatus() == modeOn end,
	function () command_end("laminar/B738/spring_toggle_switch/APU_start_pos_dn") end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
turnAroundProc:addItem(ProcedureItem:new("  #spell|APU# GENERATOR BUS SWITCHES","ON",FlowItem.actorFO,2,
	function () return sysElectric.apuGenBusOff:getStatus() == 0 end,
	function () sysElectric.apuGenBus1:actuate(1) sysElectric.apuGenBus2:actuate(1) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
turnAroundProc:addItem(ProcedureItem:new("APU BLEED AIR SWITCH","ON",FlowItem.actorFO,2,
	function () return sysAir.apuBleedSwitch:getStatus() == modeOn end,
	function () sysAir.apuBleedSwitch:actuate(modeOn) end,
	function () return activePrefSet:get("aircraft:powerup_apu") == false end))
turnAroundProc:addItem(SimpleProcedureItem:new("==== IRS Alignment"))
turnAroundProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","OFF",FlowItem.actorFO,2,"irs_mode_initial_off",
	function () return sysGeneral.irsUnitGroup:getStatus() == modeOff end,
	function () sysGeneral.irsUnitGroup:actuate(sysGeneral.irsUnitOFF) end))
turnAroundProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","ALIGN",FlowItem.actorFO,2,"irs_mode_align",
	function () return sysGeneral.irsUnitGroup:getStatus() == sysGeneral.irsUnitALIGN*2 end,
	function () sysGeneral.irsUnitGroup:actuate(sysGeneral.irsUnitALIGN) end))
turnAroundProc:addItem(IndirectProcedureItem:new("IRS MODE SELECTORS","THEN NAV",FlowItem.actorFO,2,"irs_mode_nav_again",
	function () return sysGeneral.irsUnitGroup:getStatus() == sysGeneral.irsUnitNAV*2 end,
	function () sysGeneral.irsUnitGroup:actuate(sysGeneral.irsUnitNAV) end))

turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 1","SET","SYS",1,"c_d_2",
	function () return true end,
	function () 
		sysMCP.vhfNavSwitch:actuate(0)
		sysMCP.irsNavSwitch:setValue(0)
...
turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 2","SET","SYS",1,"c_d_3",
	function () return true end,
	function () 
		sysElectric.dcPowerSwitch:actuate(sysElectric.dcPwrBAT)
...
turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 3","SET","SYS",1,"c_d_4",
	function () return true end,
	function () 
		set("laminar/B738/toggle_switch/eq_cool_exhaust",0)
		set("laminar/B738/toggle_switch/eq_cool_supply",0)
...
turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 4","SET","SYS",1,"c_d_5",
	function () return true end,
	function () 
		sysAice.windowHeatGroup:actuate(0)
		sysAice.probeHeatGroup:actuate(0)
...
turnAroundProc:addItem(IndirectProcedureItem:new("OVERHEAD COLUMN 5","SET","SYS",1,"c_d_6",
	function () return true end,
	function () 
		set("laminar/B738/toggle_switch/air_temp_source",3)
		sysAir.contCabTemp:setValue(0.5) 
...
turnAroundProc:addItem(IndirectProcedureItem:new("LIGHT PANEL","SET","SYS",1,"c_d_7",
	function () return true end,
	function () 
		sysLights.landLightGroup:actuate(0)
		sysLights.rwyLightGroup:actuate(0)
...
turnAroundProc:addItem(IndirectProcedureItem:new("THE REST","SET","SYS",1,"c_d_8",
	function () return true end,
	function () 
		if kc_is_daylight() then		
			sysLights.domeLightSwitch:actuate(modeOff)
