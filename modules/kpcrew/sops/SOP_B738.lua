...
preflightFOProc:addItem(IndirectProcedureItem:new("OVHT FIRE TEST SWITCH","HOLD RIGHT",ChecklistItem.actorFO,1,function (self) return  sysEngines.ovhtFireTestSwitch:getStatus() > 0 end,nil,nil))
...
preflightFO2Proc:addItem(ProcedureItem:new("AIR TEMPERATURE SOURCE SELECTOR","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("TRIM AIR SWITCH","ON",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("RECIRCULATION FAN SWITCHES","AUTO",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("AIR CONDITIONING PACK SWITCHES","AUTO OR HIGH",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("ISOLATION VALVE SWITCH","OPEN",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("ENGINE BLEED AIR SWITCHES","ON",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("APU BLEED AIR SWITCH","ON",ChecklistItem.actorFO,1,nil,nil,nil))
...
preflightFO2Proc:addItem(ProcedureItem:new("PRESSURIZATION MODE SELECTOR","AUTO",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("Lighting panel"))
preflightFO2Proc:addItem(ProcedureItem:new("LANDING LIGHT SWITCHES","RETRACT AND OFF",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("RUNWAY TURNOFF LIGHT SWITCHES","OFF",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("TAXI LIGHT SWITCH","OFF",ChecklistItem.actorFO,1,nil,nil,nil))
...
preflightFO2Proc:addItem(ProcedureItem:new("ANTI–COLLISION LIGHT SWITCH","OFF",ChecklistItem.actorFO,1,nil,nil,nil))
...
preflightFO2Proc:addItem(ProcedureItem:new("IGNITION SELECT SWITCH","IGN L OR R",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("ENGINE START SWITCHES","OFF",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("Mode control panel"))
preflightFO2Proc:addItem(ProcedureItem:new("COURSE(S)","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("FLIGHT DIRECTOR SWITCHES","ON",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("EFIS control panel"))
preflightFO2Proc:addItem(ProcedureItem:new("MINIMUMS REFERENCE SELECTOR","RADIO OR BARO",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("MINIMUMS SELECTOR","SET DH OR DA REFERENCE",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("FLIGHT PATH VECTOR SWITCH","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("METERS SWITCH","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("BAROMETRIC REFERENCE SELECTOR","IN OR HPA",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("BAROMETRIC SELECTOR","SET LOCAL ALTIMETER SETTING",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("VOR/ADF SWITCHES","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("MODE SELECTOR","MAP",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("CENTER SWITCH","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("RANGE SELECTOR","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("TRAFFIC SWITCH","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("WEATHER RADAR","OFF",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("MAP SWITCHES","AS NEEDED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("OXYGEN","TEST AND SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("CLOCK","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("DISPLAY SELECT PANEL","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("MAIN PANEL DISPLAY UNITS SELECTOR","NORM",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("LOWER DISPLAY UNIT SELECTOR","NORM",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("BRAKE TEMP LIGHT","VERIFY EXTINGUISHED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("GROUND PROXIMITY panel"))
preflightFO2Proc:addItem(ProcedureItem:new("FLAP INHIBIT SWITCH","GUARD CLOSED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("GEAR INHIBIT SWITCH","GUARD CLOSED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("TERRAIN INHIBIT SWITCH","GUARD CLOSED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("Landing gear panel"))
preflightFO2Proc:addItem(ProcedureItem:new("LANDING GEAR LEVER","DN",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("AUTO BRAKE SELECT SWITCH","RTO",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("ANTISKID INOP LIGHT","VERIFY EXTINGUISHED",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(SimpleProcedureItem:new("Radio tuning panel"))
preflightFO2Proc:addItem(ProcedureItem:new("VHF COMMUNICATIONS RADIOS","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("VHF NAVIGATION RADIOS","SET FOR DEPARTURE",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("AUDIO CONTROL PANEL","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("ADF RADIOS","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("WEATHER RADAR PANEL","SET",ChecklistItem.actorFO,1,nil,nil,nil))
preflightFO2Proc:addItem(ProcedureItem:new("TRANSPONDER PANEL","SET",ChecklistItem.actorFO,1,nil,nil,nil))
