...
sysRadios.xpdrSwitch 		= TwoStateCmdSwitch:new ("XPDR","sim/cockpit2/radios/actuators/transponder_mode",0,
	"sim/transponder/transponder_on","sim/transponder/transponder_off","nocommand")
