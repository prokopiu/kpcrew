...
local drefFlapPos = "sim/cockpit2/controls/flap_ratio"
local cmdFlapsUp = "sim/flight_controls/flaps_up"
local cmdFlapsDown = "sim/flight_controls/flaps_down"

local cmdElevTrimDown = "laminar/B738/flight_controls/pitch_trim_down"
local cmdElevTrimUp = "laminar/B738/flight_controls/pitch_trim_up"
