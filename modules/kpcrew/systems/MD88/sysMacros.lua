...
function kc_macro_mcp_preflight()
	...
	sysMCP.athrSwitch:actuate(0)
	sysMCP.iasSelector:setValue(activePrefSet:get("takeoff:v2"))
	sysMCP.hdgSelector:setValue(activePrefSet:get("departure:initHeading"))
	sysMCP.altSelector:setValue(activePrefSet:get("departure:initAlt"))
	sysMCP.vspSelector:setValue(0)
	sysMCP.discAPSwitch:actuate(0)
	sysMCP.yawDamper:actuate(0)
end
