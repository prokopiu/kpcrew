...
sysMCP.iasSelector 			= MultiStateCmdSwitch:new("ias","sim/cockpit2/autopilot/airspeed_dial_kts",0,
	"1-sim/command/mcpSpdRotary_rotary+","1-sim/command/mcpSpdRotary_rotary-",100,340,false)
...
-- HDG
sysMCP.hdgSelector 			= MultiStateCmdSwitch:new("hdg","sim/cockpit2/autopilot/airspeed_dial_kts_mach",0,
	"1-sim/command/mcpHdgRotary_rotary-","1-sim/command/mcpHdgRotary_rotary+",100,360,false)
...
-- ALT
sysMCP.altSelector 			= MultiStateCmdSwitch:new("alt","sim/cockpit2/autopilot/airspeed_dial_kts_mach",0,
	"1-sim/command/mcpAltRotary_rotary-","1-sim/command/mcpAltRotary_rotary+",100,360,false)
