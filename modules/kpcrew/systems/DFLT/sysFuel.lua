...
-- Fuel pumps
sysFuel.fuelPumpLeftAft 	= TwoStateCmdSwitch:new ("fuelpumpleftaft","sim/cockpit2/fuel/fuel_tank_pump_on",0,
	"sim/fuel/fuel_pump_1_on","sim/fuel/fuel_pump_1_off","sim/fuel/fuel_pump_1_tog")
sysFuel.fuelPumpLeftFwd 	= TwoStateCmdSwitch:new ("fuelpumpleftfwd","sim/cockpit2/fuel/fuel_tank_pump_on",1,
...
sysFuel.fuelPumpRightFwd 	= TwoStateCmdSwitch:new("fuelpumprightfwd","sim/cockpit2/fuel/fuel_tank_pump_on",3,
	"sim/fuel/fuel_pump_4_on","sim/fuel/fuel_pump_4_off","sim/fuel/fuel_pump_4_tog")
sysFuel.fuelPumpCtrLeft 	= TwoStateCmdSwitch:new ("fuelpumpctrleft","sim/cockpit2/fuel/fuel_tank_pump_on",4,
	"sim/fuel/fuel_pump_5_on","sim/fuel/fuel_pump_5_off","sim/fuel/fuel_pump_5_tog")
sysFuel.fuelPumpCtrRight 	= TwoStateCmdSwitch:new("fuelpumpctrright","sim/cockpit2/fuel/fuel_tank_pump_on",5,
	"sim/fuel/fuel_pump_6_on","sim/fuel/fuel_pump_6_off","sim/fuel/fuel_pump_6_tog")
