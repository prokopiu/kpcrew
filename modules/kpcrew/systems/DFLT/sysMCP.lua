...
-- VORLOC
sysMCP.vorlocSwitch 		= TwoStateCustomSwitch:new("vorloc","sim/cockpit2/autopilot/heading_mode",0,
function ()
...
-- SPEED
sysMCP.speedSwitch 			= TwoStateDrefSwitch:new("speed",0,"sim/autopilot/autothrottle_toggle")
...
-- YAW DAMPER
sysMCP.yawDamper			= TwoStateDrefSwitch:new("yawdamper","sim/cockpit2/switches/yaw_damper_on",0)
