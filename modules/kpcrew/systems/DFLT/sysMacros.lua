...
function kc_macro_state_cold_and_dark()
	...
	set("sim/cockpit2/engine/actuators/throttle_ratio_all",0)
	...
	set_array("sim/cockpit/engine/inverter_on",0,0)
	set_array("sim/cockpit/engine/inverter_on",1,0)
	set("sim/cockpit2/electrical/cross_tie",0)
	...
	set("sim/cockpit/switches/auto_brake_settings",1)
	set("sim/cockpit2/controls/flap_handle_deploy_ratio",0)
...
function kc_macro_state_turnaround()
	...
	-- sysElectric.apuStartSwitch:actuate(1)
