...
-- Fuel Dump
sysFuel.fuelDumpGuard 		= TwoStateToggleSwitch:new("","Rotate/aircraft/controls/fuel_dump_grd",0,
	"Rotate/aircraft/controls_c/fuel_dump_grd")

-- Manifold Drain
sysFuel.manifoldDrainGuard 	= TwoStateToggleSwitch:new("","Rotate/aircraft/controls/fuel_manif_drain_grd",0,
	"Rotate/aircraft/controls_c/fuel_manif_drain_grd")
