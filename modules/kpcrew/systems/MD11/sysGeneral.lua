...
-- Parking Brake
sysGeneral.parkBrakeSwitch	= TwoStateCmdSwitch:new("parkbrake","Rotate/aircraft/controls/park_brake",0,
	"Rotate/aircraft/controls_c/park_brake_up","Rotate/aircraft/controls_c/park_brake_dn","nocommand")

-- Landing Gear
sysGeneral.GearSwitch 		= TwoStateCmdSwitch:new("gear","Rotate/aircraft/controls/gear_handle",0,
	"Rotate/aircraft/controls_c/gear_handle_dn","Rotate/aircraft/controls_c/gear_handle_up","nocommand")
