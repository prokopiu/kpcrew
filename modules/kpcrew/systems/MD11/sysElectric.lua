...
-- Emergency Power
sysElectric.emerPwrSelector	= MultiStateCmdSwitch:new("","Rotate/aircraft/controls/emer_pwr",0,
	"Rotate/aircraft/controls_c/emer_pwr_up","Rotate/aircraft/controls_c/emer_pwr_dn")

-- Battery switch and guard
sysElectric.batteryGuard 	= TwoStateToggleSwitch:new("","Rotate/aircraft/controls/battery_grd",0,
	"Rotate/aircraft/controls_c/battery_grd")
sysElectric.batterySwitch 	= TwoStateToggleSwitch:new("","sim/cockpit/electrical/battery_on",0,
	"Rotate/aircraft/controls_c/battery")

-- GPU
sysElectric.GPU 			= TwoStateToggleSwitch:new("","Rotate/aircraft/fx/show_gpu_truck",0,
	"Rotate/aircraft/operation_c/ext_pwr_request")

-- EXT PWR Switch
sysElectric.extPWRSwitch 	= TwoStateToggleSwitch:new("","Rotate/aircraft/systems/elec_ext_pwr_on_lt",0,
	"Rotate/aircraft/controls_c/ext_pwr")
