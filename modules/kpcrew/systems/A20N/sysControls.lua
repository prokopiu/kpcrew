...
-- Flaps 
sysControls.flapsSwitch = MultiStateCmdSwitch:new("flaps","sim/cockpit2/controls/flap_ratio",0,"sim/flight_controls/flaps_up","sim/flight_controls/flaps_down")
...
sysControls.speedBrake = TwoStateDrefSwitch:new("speedbrake","jd/spdbrakes/handle",0)
